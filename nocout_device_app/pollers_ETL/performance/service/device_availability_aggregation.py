"""
device_availability_aggregation.py
==================================

Usage ::
python device_availability_aggregation.py -r mongodb -t 24 -f daily -s device_availability -d performance_networkavailabilitydaily
python device_availability_aggregation.py -r mysql -t 168 -f weekly -s performance_networkavailabilitydaily -d performance_networkavailabilityweekly
Options ::
...
def quantify_utilization_data(host_specific_data):
	...
	for doc in host_specific_data:
		...
		if time_frame == 'half_hourly':
			...
			# Pivot the time to 23:55:00 month end
