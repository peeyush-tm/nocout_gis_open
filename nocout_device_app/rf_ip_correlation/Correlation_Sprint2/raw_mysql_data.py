...
def mysql_to_inventory_data():
    try:
	logger.error('Task called mysql_to_inventory_data')
	...
	#logger.error('alarm mapping dict {0}'.format(alarm_mapping))
	...
	#logger.error('alarm  priority {0}'.format(redis_alarm_priority))
