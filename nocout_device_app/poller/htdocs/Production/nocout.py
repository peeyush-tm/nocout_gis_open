...
def sync():
    ...
    out = tarfile.open('/apps/omd/sites/master_UA/etc/check_mk/conf.d/wato_backup.tar.gz', mode='w:gz')
    try:
...
def nocout_untar_backup_folder():
    ...
    try:
        t = tarfile.open('/apps/omd/sites/master_UA/etc/check_mk/conf.d/wato_backup.tar.gz', 'r:gz')
