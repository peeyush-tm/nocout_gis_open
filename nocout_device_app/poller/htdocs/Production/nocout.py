...
def sync():
    ...
    os.chdir('/apps/omd/sites/main_UA/etc/check_mk/conf.d/wato/')
    out = tarfile.open('/apps/omd/sites/main_UA/etc/check_mk/conf.d/wato_backup.tar.gz', mode='w:gz')
    try:
...
def nocout_untar_backup_folder():
    ...
    try:
        t = tarfile.open('/apps/omd/sites/main_UA/etc/check_mk/conf.d/wato_backup.tar.gz', 'r:gz')
        t.extractall('/apps/omd/sites/main_UA/etc/check_mk/conf.d/wato/')
    except Exception, err:
