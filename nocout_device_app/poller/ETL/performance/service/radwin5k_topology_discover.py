"""
Radwin5k_topology_discovery.py
=======================

This file contains the code for extracting and collecting the data for Radwin5k topology and storing this data into embeded mongodb database.
