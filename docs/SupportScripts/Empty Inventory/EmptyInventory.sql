...
CREATE TABLE `inventory_substation` (
  ...
  KEY `inventory_substation_ec2878b5` (`city_id`),
  KEY `inventory_substation_1adbbb67` (`state_id`),
  KEY `inventory_substation_a65e5e94` (`country_id`),
...
CREATE TABLE `inventory_basestation` (
  ...
  `maintenance_status` varchar(250),
  `provisioning_status` varchar(250),
  `hssu_port` varchar(40),
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
  ...
  KEY `inventory_basestation_1adbbb67` (`state_id`),
  KEY `inventory_basestation_ec2878b5` (`city_id`),
  KEY `inventory_basestation_a65e5e94` (`country_id`),
...
CREATE TABLE `device_device` (
  ...
  KEY `device_device_ec2878b5` (`city_id`),
  KEY `device_device_1adbbb67` (`state_id`),
  KEY `device_device_a65e5e94` (`country_id`),
