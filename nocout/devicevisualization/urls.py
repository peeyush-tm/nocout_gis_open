...
urlpatterns = patterns('',
	...
	url(r'^kmz/(?P<page_type>\w+)/(?P<kmz_id>\d+)/$', views.KmzViewAction.as_view(), name='kmz_view_action'),
	# url(r'^kmz/google_earth/(?P<kmz_id>\d+)/$', views.KmzViewAction.as_view(), name='kmz_view_action'),
	# url(r'^kmz/white_background/(?P<kmz_id>\d+)/$', views.KmzViewAction.as_view(), name='kmz_view_action'),
