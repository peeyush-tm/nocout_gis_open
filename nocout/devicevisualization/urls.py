...
urlpatterns = patterns('',
                       ...
                       url(r'^gis/$', views.locate_devices, name='google_maps_url'),
                       url(r'^google_earth/$', views.load_google_earth, name='google_settelite_view'),
                       url(r'^googleEarth/$', views.load_earth, name='google_earth_url'),
                       url(r'^white_background/$', views.load_white_background, name='white_background_map'),
