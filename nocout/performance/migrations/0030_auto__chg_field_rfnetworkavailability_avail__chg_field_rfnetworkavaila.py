...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RfNetworkAvailability.avail'
        db.alter_column(u'performance_rfnetworkavailability', 'avail', self.gf('django.db.models.fields.FloatField')(null=True))

        # Renaming column for 'RfNetworkAvailability.technology' to match new field type.
        db.rename_column(u'performance_rfnetworkavailability', 'technology', 'technology_id')
        # Changing field 'RfNetworkAvailability.technology'
        db.alter_column(u'performance_rfnetworkavailability', 'technology_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.DeviceTechnology']))
        # Adding index on 'RfNetworkAvailability', fields ['technology']
        db.create_index(u'performance_rfnetworkavailability', ['technology_id'])


        # Changing field 'RfNetworkAvailability.unavail'
        db.alter_column(u'performance_rfnetworkavailability', 'unavail', self.gf('django.db.models.fields.FloatField')(null=True))
        # Adding unique constraint on 'SpotDashboard', fields ['sector_sector_id']
        db.create_unique(u'performance_spotdashboard', ['sector_sector_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SpotDashboard', fields ['sector_sector_id']
        db.delete_unique(u'performance_spotdashboard', ['sector_sector_id'])

        # Removing index on 'RfNetworkAvailability', fields ['technology']
        db.delete_index(u'performance_rfnetworkavailability', ['technology_id'])


        # Changing field 'RfNetworkAvailability.avail'
        db.alter_column(u'performance_rfnetworkavailability', 'avail', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Renaming column for 'RfNetworkAvailability.technology' to match new field type.
        db.rename_column(u'performance_rfnetworkavailability', 'technology_id', 'technology')
        # Changing field 'RfNetworkAvailability.technology'
        db.alter_column(u'performance_rfnetworkavailability', 'technology', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'RfNetworkAvailability.unavail'
        db.alter_column(u'performance_rfnetworkavailability', 'unavail', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'performance.eventnetworkstatus': {
            'Meta': {'object_name': 'EventNetworkStatus'},
            'avg_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'check_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'critical_threshold': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'current_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'performance.eventservicestatus': {
            'Meta': {'object_name': 'EventServiceStatus'},
            'avg_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'check_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'critical_threshold': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'current_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
