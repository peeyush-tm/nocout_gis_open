...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerformanceServiceDaily'
        db.create_table(u'performance_performanceservicedaily', (
        ...
        db.send_create_signal(u'performance', ['PerformanceServiceDaily'])

        # Adding model 'PerformanceServiceYearly'
        db.create_table(u'performance_performanceserviceyearly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['PerformanceServiceYearly'])

        # Adding model 'PerformanceServiceHourly'
        db.create_table(u'performance_performanceservicehourly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['PerformanceServiceHourly'])

        # Adding model 'PerformanceServiceBiHourly'
        db.create_table(u'performance_performanceservicebihourly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['PerformanceServiceBiHourly'])

        # Adding model 'PerformanceServiceMonthly'
        db.create_table(u'performance_performanceservicemonthly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['PerformanceServiceMonthly'])

        # Adding model 'PerformanceServiceWeekly'
        db.create_table(u'performance_performanceserviceweekly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['PerformanceServiceWeekly'])


    def backwards(self, orm):
        # Deleting model 'PerformanceServiceDaily'
        db.delete_table(u'performance_performanceservicedaily')

        # Deleting model 'PerformanceServiceYearly'
        db.delete_table(u'performance_performanceserviceyearly')

        # Deleting model 'PerformanceServiceHourly'
        db.delete_table(u'performance_performanceservicehourly')

        # Deleting model 'PerformanceServiceBiHourly'
        db.delete_table(u'performance_performanceservicebihourly')

        # Deleting model 'PerformanceServiceMonthly'
        db.delete_table(u'performance_performanceservicemonthly')

        # Deleting model 'PerformanceServiceWeekly'
        db.delete_table(u'performance_performanceserviceweekly')
