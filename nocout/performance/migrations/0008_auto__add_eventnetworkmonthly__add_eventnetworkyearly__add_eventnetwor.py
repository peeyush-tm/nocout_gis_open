...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventNetworkMonthly'
        db.create_table(u'performance_eventnetworkmonthly', (
        ...
        db.send_create_signal(u'performance', ['EventNetworkMonthly'])

        # Adding model 'EventNetworkYearly'
        db.create_table(u'performance_eventnetworkyearly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['EventNetworkYearly'])

        # Adding model 'EventNetworkDaily'
        db.create_table(u'performance_eventnetworkdaily', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['EventNetworkDaily'])

        # Adding model 'EventNetworkWeekly'
        db.create_table(u'performance_eventnetworkweekly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['EventNetworkWeekly'])


    def backwards(self, orm):
        # Deleting model 'EventNetworkMonthly'
        db.delete_table(u'performance_eventnetworkmonthly')

        # Deleting model 'EventNetworkYearly'
        db.delete_table(u'performance_eventnetworkyearly')

        # Deleting model 'EventNetworkDaily'
        db.delete_table(u'performance_eventnetworkdaily')

        # Deleting model 'EventNetworkWeekly'
        db.delete_table(u'performance_eventnetworkweekly')
