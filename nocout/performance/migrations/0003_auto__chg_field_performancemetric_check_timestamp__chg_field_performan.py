...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'performance_performancemetric', 'check_timestamp', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        u'performance.performancemetric': {
            ...
            'check_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'sys_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
