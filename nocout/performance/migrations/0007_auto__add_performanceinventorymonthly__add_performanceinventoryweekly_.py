...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerformanceInventoryMonthly'
        db.create_table(u'performance_performanceinventorymonthly', (
        ...
        db.send_create_signal(u'performance', ['PerformanceInventoryMonthly'])

        # Adding model 'PerformanceInventoryWeekly'
        db.create_table(u'performance_performanceinventoryweekly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['PerformanceInventoryWeekly'])

        # Adding model 'PerformanceInventoryYearly'
        db.create_table(u'performance_performanceinventoryyearly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['PerformanceInventoryYearly'])


    def backwards(self, orm):
        # Deleting model 'PerformanceInventoryMonthly'
        db.delete_table(u'performance_performanceinventorymonthly')

        # Deleting model 'PerformanceInventoryWeekly'
        db.delete_table(u'performance_performanceinventoryweekly')

        # Deleting model 'PerformanceInventoryYearly'
        db.delete_table(u'performance_performanceinventoryyearly')
