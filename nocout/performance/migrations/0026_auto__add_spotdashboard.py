...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SpotDashboard'
        db.create_table(u'performance_spotdashboard', (
            ...
            ('sector_sector_id', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True, null=True, blank=True)),
            ('sector_sector_configured_on', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True, null=True, blank=True)),
            ('sector_device_technology', self.gf('django.db.models.fields.CharField')(max_length=64, unique=True, null=True, blank=True)),
            ('ul_issue_1', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ul_issue_2', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ul_issue_3', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ul_issue_4', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ul_issue_5', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ul_issue_6', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('augment_1', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('augment_2', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('augment_3', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('augment_4', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('augment_5', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('augment_6', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('sia_1', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('sia_2', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('sia_3', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('sia_4', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('sia_5', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('sia_6', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'performance', ['SpotDashboard'])


    def backwards(self, orm):
        # Deleting model 'SpotDashboard'
        db.delete_table(u'performance_spotdashboard')
    ...
    models = {
        ...
        u'performance.spotdashboard': {
            ...
            'sector_device_technology': ('django.db.models.fields.CharField', [], {'max_length': '64', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'sector_sector_configured_on': ('django.db.models.fields.CharField', [], {'max_length': '64', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
