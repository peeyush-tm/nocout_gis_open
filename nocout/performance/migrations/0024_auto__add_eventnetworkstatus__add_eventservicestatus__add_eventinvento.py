...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EventInventoryStatus'
        db.create_table(u'performance_eventinventorystatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['EventInventoryStatus'])

        # Adding model 'EventMachineStatus'
        db.create_table(u'performance_eventmachinestatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['EventMachineStatus'])

        # Adding model 'EventStatusStatus'
        db.create_table(u'performance_eventstatusstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['EventStatusStatus'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EventInventoryStatus'
        db.delete_table(u'performance_eventinventorystatus')

        # Deleting model 'EventMachineStatus'
        db.delete_table(u'performance_eventmachinestatus')

        # Deleting model 'EventStatusStatus'
        db.delete_table(u'performance_eventstatusstatus')
    ...
    models = {
        ...
        u'performance.inventorystatus': {
            'Meta': {'ordering': "['-sys_timestamp']", 'object_name': 'InventoryStatus', 'index_together': "[['device_name', 'service_name', 'data_source']]"},
        ...
        u'performance.networkstatus': {
            'Meta': {'ordering': "['-sys_timestamp']", 'object_name': 'NetworkStatus', 'index_together': "[['device_name', 'service_name', 'data_source']]"},
            'age': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'avg_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'check_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'critical_threshold': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'performance.servicestatus': {
            'Meta': {'ordering': "['-sys_timestamp']", 'object_name': 'ServiceStatus', 'index_together': "[['device_name', 'service_name', 'data_source']]"},
            'age': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'avg_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'check_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'critical_threshold': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'performance.status': {
            'Meta': {'ordering': "['-sys_timestamp']", 'object_name': 'Status', 'index_together': "[['device_name', 'service_name', 'data_source']]"},
            'age': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'avg_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'check_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'critical_threshold': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
