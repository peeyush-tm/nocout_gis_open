...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UtilizationMonthly'
        db.create_table(u'performance_utilizationmonthly', (
            ...
            ('refer', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=32, null=True, blank=True)),
        ))
        db.send_create_signal(u'performance', ['UtilizationMonthly'])

        # Adding model 'UtilizationDaily'
        db.create_table(u'performance_utilizationdaily', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['UtilizationDaily'])

        # Adding model 'UtilizationWeekly'
        db.create_table(u'performance_utilizationweekly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['UtilizationWeekly'])

        # Adding model 'UtilizationYearly'
        db.create_table(u'performance_utilizationyearly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['UtilizationYearly'])

        # Adding model 'Utilization'
        db.create_table(u'performance_utilization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['Utilization'])

        # Adding model 'UtilizationStatus'
        db.create_table(u'performance_utilizationstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['UtilizationStatus'])


    def backwards(self, orm):
        # Deleting model 'UtilizationMonthly'
        db.delete_table(u'performance_utilizationmonthly')

        # Deleting model 'UtilizationDaily'
        db.delete_table(u'performance_utilizationdaily')

        # Deleting model 'UtilizationWeekly'
        db.delete_table(u'performance_utilizationweekly')

        # Deleting model 'UtilizationYearly'
        db.delete_table(u'performance_utilizationyearly')

        # Deleting model 'Utilization'
        db.delete_table(u'performance_utilization')

        # Deleting model 'UtilizationStatus'
        db.delete_table(u'performance_utilizationstatus')
    ...
    models = {
        ...
        u'performance.performanceinventorydaily': {
            'Meta': {'object_name': 'PerformanceInventoryDaily'},
            'avg_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'check_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'critical_threshold': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'current_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'performance.performancestatusdaily': {
            'Meta': {'object_name': 'PerformanceStatusDaily'},
            'avg_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'check_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'critical_threshold': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'current_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'performance.utilizationdaily': {
            'Meta': {'object_name': 'UtilizationDaily'},
            'age': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'avg_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'check_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'critical_threshold': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'performance.utilizationmonthly': {
            'Meta': {'object_name': 'UtilizationMonthly'},
            'age': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'avg_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'check_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'critical_threshold': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'performance.utilizationstatus': {
            'Meta': {'object_name': 'UtilizationStatus'},
            'age': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'avg_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'check_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'critical_threshold': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'performance.utilizationweekly': {
            'Meta': {'object_name': 'UtilizationWeekly'},
            'age': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'avg_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'check_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'critical_threshold': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'performance.utilizationyearly': {
            'Meta': {'object_name': 'UtilizationYearly'},
            'age': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'avg_value': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'check_timestamp': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'critical_threshold': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
