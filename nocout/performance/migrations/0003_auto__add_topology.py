...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'performance_topology', (
            ...
            ('mac_address', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=20, null=True, blank=True)),
            ('sector_id', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=32, null=True, blank=True)),
            ('connected_device_ip', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=20, null=True, blank=True)),
            ('connected_device_mac', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=20, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['Topology'])


    def backwards(self, orm):
        # Deleting model 'Topology'
        db.delete_table(u'performance_topology')
