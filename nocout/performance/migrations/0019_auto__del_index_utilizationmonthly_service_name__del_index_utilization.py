...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'UtilizationMonthly', fields ['service_name']
        db.delete_index(u'performance_utilizationmonthly', ['service_name'])

        # Removing index on 'UtilizationMonthly', fields ['device_name']
        db.delete_index(u'performance_utilizationmonthly', ['device_name'])

        # Removing index on 'UtilizationMonthly', fields ['data_source']
        db.delete_index(u'performance_utilizationmonthly', ['data_source'])

        # Adding index on 'UtilizationMonthly', fields ['device_name', 'service_name', 'data_source']
        db.create_index(u'performance_utilizationmonthly', ['device_name', 'service_name', 'data_source'])

        # Removing index on 'UtilizationYearly', fields ['service_name']
        db.delete_index(u'performance_utilizationyearly', ['service_name'])

        # Removing index on 'UtilizationYearly', fields ['device_name']
        db.delete_index(u'performance_utilizationyearly', ['device_name'])

        # Removing index on 'UtilizationYearly', fields ['data_source']
        db.delete_index(u'performance_utilizationyearly', ['data_source'])

        # Adding index on 'UtilizationYearly', fields ['device_name', 'service_name', 'data_source']
        db.create_index(u'performance_utilizationyearly', ['device_name', 'service_name', 'data_source'])

        # Removing index on 'UtilizationDaily', fields ['service_name']
        db.delete_index(u'performance_utilizationdaily', ['service_name'])

        # Removing index on 'UtilizationDaily', fields ['device_name']
        db.delete_index(u'performance_utilizationdaily', ['device_name'])

        # Removing index on 'UtilizationDaily', fields ['data_source']
        db.delete_index(u'performance_utilizationdaily', ['data_source'])

        # Adding index on 'UtilizationDaily', fields ['device_name', 'service_name', 'data_source']
        db.create_index(u'performance_utilizationdaily', ['device_name', 'service_name', 'data_source'])

        # Removing index on 'UtilizationWeekly', fields ['service_name']
        db.delete_index(u'performance_utilizationweekly', ['service_name'])

        # Removing index on 'UtilizationWeekly', fields ['device_name']
        db.delete_index(u'performance_utilizationweekly', ['device_name'])

        # Removing index on 'UtilizationWeekly', fields ['data_source']
        db.delete_index(u'performance_utilizationweekly', ['data_source'])

        # Adding index on 'UtilizationWeekly', fields ['device_name', 'service_name', 'data_source']
        db.create_index(u'performance_utilizationweekly', ['device_name', 'service_name', 'data_source'])


    def backwards(self, orm):
        # Removing index on 'UtilizationWeekly', fields ['device_name', 'service_name', 'data_source']
        db.delete_index(u'performance_utilizationweekly', ['device_name', 'service_name', 'data_source'])

        # Adding index on 'UtilizationWeekly', fields ['data_source']
        db.create_index(u'performance_utilizationweekly', ['data_source'])

        # Adding index on 'UtilizationWeekly', fields ['device_name']
        db.create_index(u'performance_utilizationweekly', ['device_name'])

        # Adding index on 'UtilizationWeekly', fields ['service_name']
        db.create_index(u'performance_utilizationweekly', ['service_name'])

        # Removing index on 'UtilizationDaily', fields ['device_name', 'service_name', 'data_source']
        db.delete_index(u'performance_utilizationdaily', ['device_name', 'service_name', 'data_source'])

        # Adding index on 'UtilizationDaily', fields ['data_source']
        db.create_index(u'performance_utilizationdaily', ['data_source'])

        # Adding index on 'UtilizationDaily', fields ['device_name']
        db.create_index(u'performance_utilizationdaily', ['device_name'])

        # Adding index on 'UtilizationDaily', fields ['service_name']
        db.create_index(u'performance_utilizationdaily', ['service_name'])

        # Removing index on 'UtilizationYearly', fields ['device_name', 'service_name', 'data_source']
        db.delete_index(u'performance_utilizationyearly', ['device_name', 'service_name', 'data_source'])

        # Adding index on 'UtilizationYearly', fields ['data_source']
        db.create_index(u'performance_utilizationyearly', ['data_source'])

        # Adding index on 'UtilizationYearly', fields ['device_name']
        db.create_index(u'performance_utilizationyearly', ['device_name'])

        # Adding index on 'UtilizationYearly', fields ['service_name']
        db.create_index(u'performance_utilizationyearly', ['service_name'])

        # Removing index on 'UtilizationMonthly', fields ['device_name', 'service_name', 'data_source']
        db.delete_index(u'performance_utilizationmonthly', ['device_name', 'service_name', 'data_source'])

        # Adding index on 'UtilizationMonthly', fields ['data_source']
        db.create_index(u'performance_utilizationmonthly', ['data_source'])

        # Adding index on 'UtilizationMonthly', fields ['device_name']
        db.create_index(u'performance_utilizationmonthly', ['device_name'])

        # Adding index on 'UtilizationMonthly', fields ['service_name']
        db.create_index(u'performance_utilizationmonthly', ['service_name'])
