...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerformanceInventoryDaily'
        db.create_table(u'performance_performanceinventorydaily', (
        ...
        db.send_create_signal(u'performance', ['PerformanceInventoryDaily'])

        # Adding model 'PerformanceStatusDaily'
        db.create_table(u'performance_performancestatusdaily', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['PerformanceStatusDaily'])


    def backwards(self, orm):
        # Deleting model 'PerformanceInventoryDaily'
        db.delete_table(u'performance_performanceinventorydaily')

        # Deleting model 'PerformanceStatusDaily'
        db.delete_table(u'performance_performancestatusdaily')
