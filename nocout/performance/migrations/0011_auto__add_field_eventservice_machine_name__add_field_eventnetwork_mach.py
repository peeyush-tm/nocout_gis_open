...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventService.machine_name'
        db.add_column(u'performance_eventservice', 'machine_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventNetwork.machine_name'
        db.add_column(u'performance_eventnetwork', 'machine_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventService.machine_name'
        db.delete_column(u'performance_eventservice', 'machine_name')

        # Deleting field 'EventNetwork.machine_name'
        db.delete_column(u'performance_eventnetwork', 'machine_name')
