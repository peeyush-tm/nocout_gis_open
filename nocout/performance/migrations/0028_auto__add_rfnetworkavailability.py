...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RfNetworkAvailability'
        db.create_table(u'performance_rfnetworkavailability', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('technology', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True, blank=True)),
            ('avail', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True, blank=True)),
            ('unavail', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('sys_timestamp', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'performance', ['RfNetworkAvailability'])


    def backwards(self, orm):
        # Deleting model 'RfNetworkAvailability'
        db.delete_table(u'performance_rfnetworkavailability')
    ...
    models = {
        ...
        u'performance.rfnetworkavailability': {
            ...
            'avail': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sys_timestamp': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'technology': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
