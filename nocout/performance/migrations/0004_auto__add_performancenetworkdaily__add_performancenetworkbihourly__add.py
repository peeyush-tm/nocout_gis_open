...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerformanceNetworkDaily'
        db.create_table(u'performance_performancenetworkdaily', (
        ...
        db.send_create_signal(u'performance', ['PerformanceNetworkDaily'])

        # Adding model 'PerformanceNetworkBiHourly'
        db.create_table(u'performance_performancenetworkbihourly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['PerformanceNetworkBiHourly'])

        # Adding model 'PerformanceNetworkWeekly'
        db.create_table(u'performance_performancenetworkweekly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['PerformanceNetworkWeekly'])

        # Adding model 'PerformanceNetworkYearly'
        db.create_table(u'performance_performancenetworkyearly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['PerformanceNetworkYearly'])

        # Adding model 'PerformanceNetworkMonthly'
        db.create_table(u'performance_performancenetworkmonthly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['PerformanceNetworkMonthly'])

        # Adding model 'PerformanceNetworkHourly'
        db.create_table(u'performance_performancenetworkhourly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['PerformanceNetworkHourly'])


    def backwards(self, orm):
        # Deleting model 'PerformanceNetworkDaily'
        db.delete_table(u'performance_performancenetworkdaily')

        # Deleting model 'PerformanceNetworkBiHourly'
        db.delete_table(u'performance_performancenetworkbihourly')

        # Deleting model 'PerformanceNetworkWeekly'
        db.delete_table(u'performance_performancenetworkweekly')

        # Deleting model 'PerformanceNetworkYearly'
        db.delete_table(u'performance_performancenetworkyearly')

        # Deleting model 'PerformanceNetworkMonthly'
        db.delete_table(u'performance_performancenetworkmonthly')

        # Deleting model 'PerformanceNetworkHourly'
        db.delete_table(u'performance_performancenetworkhourly')
