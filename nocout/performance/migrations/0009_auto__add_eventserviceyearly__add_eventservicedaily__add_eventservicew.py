...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventServiceYearly'
        db.create_table(u'performance_eventserviceyearly', (
        ...
        db.send_create_signal(u'performance', ['EventServiceYearly'])

        # Adding model 'EventServiceDaily'
        db.create_table(u'performance_eventservicedaily', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['EventServiceDaily'])

        # Adding model 'EventServiceWeekly'
        db.create_table(u'performance_eventserviceweekly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('service_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
            ('machine_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'performance', ['EventServiceWeekly'])


    def backwards(self, orm):
        # Deleting model 'EventServiceYearly'
        db.delete_table(u'performance_eventserviceyearly')

        # Deleting model 'EventServiceDaily'
        db.delete_table(u'performance_eventservicedaily')

        # Deleting model 'EventServiceWeekly'
        db.delete_table(u'performance_eventserviceweekly')
