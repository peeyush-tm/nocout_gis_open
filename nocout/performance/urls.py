...
urlpatterns = patterns('',
	...
	url(r'^service/(?P<service_name>\w+)/service_data_source/(?P<service_data_source_type>\w+)/(?P<page_type>\w+)/device/(?P<device_id>\d+)$', Get_Service_Type_Performance_Data.as_view())
)