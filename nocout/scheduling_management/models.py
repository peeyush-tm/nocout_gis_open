...
class Weekdays(models.Model):
    ...
    name = models.CharField('Weekdays', max_length=128, null=True, blank=True, choices=WEEKDAYS)
...
class Event(models.Model):
    ...
    repeat_every = models.IntegerField('Repeat every', null=True, blank=True)
    repeat_on = models.ManyToManyField(Weekdays, blank=True)
    ...
    device_type = models.ManyToManyField(DeviceType, blank=True)
