...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field device_type on 'Event'
        m2m_table_name = db.shorten_name(u'scheduling_management_event_device_type')
        ...
        db.create_unique(m2m_table_name, ['event_id', 'devicetype_id'])


    def backwards(self, orm):
        # Removing M2M table for field device_type on 'Event'
        db.delete_table(db.shorten_name(u'scheduling_management_event_device_type'))
    ...
    models = {
        ...
        u'scheduling_management.event': {
            ...
            'device': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['device.Device']", 'null': 'True', 'blank': 'True'}),
            'device_type': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['device.DeviceType']", 'null': 'True', 'blank': 'True'}),
