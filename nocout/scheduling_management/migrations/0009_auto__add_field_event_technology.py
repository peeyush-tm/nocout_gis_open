...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.technology'
        db.add_column(u'scheduling_management_event', 'technology',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.DeviceTechnology'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.technology'
        db.delete_column(u'scheduling_management_event', 'technology_id')
