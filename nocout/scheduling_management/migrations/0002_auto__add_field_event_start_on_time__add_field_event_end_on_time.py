...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.start_on_time'
        db.add_column(u'scheduling_management_event', 'start_on_time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2014, 12, 15, 0, 0)),
                      keep_default=False)

        # Adding field 'Event.end_on_time'
        db.add_column(u'scheduling_management_event', 'end_on_time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime(2014, 12, 15, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.start_on_time'
        db.delete_column(u'scheduling_management_event', 'start_on_time')

        # Deleting field 'Event.end_on_time'
        db.delete_column(u'scheduling_management_event', 'end_on_time')
