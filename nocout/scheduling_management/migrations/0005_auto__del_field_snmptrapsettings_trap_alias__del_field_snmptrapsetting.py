...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SNMPTrapSettings.trap_alias'
        db.delete_column(u'scheduling_management_snmptrapsettings', 'trap_alias')

        # Deleting field 'SNMPTrapSettings.trap_name'
        db.delete_column(u'scheduling_management_snmptrapsettings', 'trap_name')

        # Adding field 'SNMPTrapSettings.name'
        db.add_column(u'scheduling_management_snmptrapsettings', 'name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=150),
                      keep_default=False)

        # Adding field 'SNMPTrapSettings.alias'
        db.add_column(u'scheduling_management_snmptrapsettings', 'alias',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SNMPTrapSettings.trap_alias'
        db.add_column(u'scheduling_management_snmptrapsettings', 'trap_alias',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SNMPTrapSettings.trap_name'
        db.add_column(u'scheduling_management_snmptrapsettings', 'trap_name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=150),
                      keep_default=False)

        # Deleting field 'SNMPTrapSettings.name'
        db.delete_column(u'scheduling_management_snmptrapsettings', 'name')

        # Deleting field 'SNMPTrapSettings.alias'
        db.delete_column(u'scheduling_management_snmptrapsettings', 'alias')
    ...
    models = {
        ...
        u'scheduling_management.snmptrapsettings': {
            ...
            'alias': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
