"""
=========================================================
Module contains url configuration for 'user_profile' app.
=========================================================

Location:
* /nocout_gis/nocout/user_profile/urls.py
"""
...
urlpatterns = patterns('',
                       ...
                       url(r'^myprofile/', views.CurrentUserProfileUpdate.as_view(),
                           name='current_user_profile_update'),
                       url(r'userlistingtable/', views.UserListingTable.as_view(), name='UserListingTable'),
                       url(r'userarchivedlistingtable/', views.UserArchivedListingTable.as_view(),
                           name='UserArchivedListingTable'),
