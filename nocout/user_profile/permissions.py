...
admin_perms = [
    ...
    # 'inventory.add_iconsettings',
    # 'inventory.change_iconsettings',
    # 'inventory.delete_iconsettings',
    ...
    # 'inventory.add_thematicsettings',
    # 'inventory.change_thematicsettings',
    # 'inventory.delete_thematicsettings',
    'inventory.view_pingthematicsettings',
    # 'inventory.add_pingthematicsettings',
    # 'inventory.change_pingthematicsettings',
    # 'inventory.delete_pingthematicsettings',
