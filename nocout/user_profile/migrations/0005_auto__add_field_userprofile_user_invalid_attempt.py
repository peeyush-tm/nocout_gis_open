...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.user_invalid_attempt'
        db.add_column(u'user_profile_userprofile', 'user_invalid_attempt',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.user_invalid_attempt'
        db.delete_column(u'user_profile_userprofile', 'user_invalid_attempt')
