...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.user_invalid_attempt_at'
        db.add_column(u'user_profile_userprofile', 'user_invalid_attempt_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.user_invalid_attempt_at'
        db.delete_column(u'user_profile_userprofile', 'user_invalid_attempt_at')
