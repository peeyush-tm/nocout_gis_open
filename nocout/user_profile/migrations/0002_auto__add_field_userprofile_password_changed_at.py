...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.password_changed_at'
        db.add_column(u'user_profile_userprofile', 'password_changed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.password_changed_at'
        db.delete_column(u'user_profile_userprofile', 'password_changed_at')
