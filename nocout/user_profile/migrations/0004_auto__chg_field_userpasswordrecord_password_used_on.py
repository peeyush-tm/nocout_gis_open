...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserPasswordRecord.password_used_on'
        db.alter_column(u'user_profile_userpasswordrecord', 'password_used_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 11, 22, 0, 0)))

    def backwards(self, orm):

        # Changing field 'UserPasswordRecord.password_used_on'
        db.alter_column(u'user_profile_userpasswordrecord', 'password_used_on', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'user_profile.userpasswordrecord': {
            ...
            'password_used_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
