...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DashboardRangeStatusMonthly.reference_name'
        db.add_column(u'dashboard_dashboardrangestatusmonthly', 'reference_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Adding field 'DashboardRangeStatusDaily.reference_name'
        db.add_column(u'dashboard_dashboardrangestatusdaily', 'reference_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Adding field 'DashboardRangeStatusWeekly.reference_name'
        db.add_column(u'dashboard_dashboardrangestatusweekly', 'reference_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Adding field 'DashboardRangeStatusHourly.reference_name'
        db.add_column(u'dashboard_dashboardrangestatushourly', 'reference_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Adding field 'DashboardRangeStatusTimely.reference_name'
        db.add_column(u'dashboard_dashboardrangestatustimely', 'reference_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Adding field 'DashboardRangeStatusYearly.reference_name'
        db.add_column(u'dashboard_dashboardrangestatusyearly', 'reference_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DashboardRangeStatusMonthly.reference_name'
        db.delete_column(u'dashboard_dashboardrangestatusmonthly', 'reference_name')

        # Deleting field 'DashboardRangeStatusDaily.reference_name'
        db.delete_column(u'dashboard_dashboardrangestatusdaily', 'reference_name')

        # Deleting field 'DashboardRangeStatusWeekly.reference_name'
        db.delete_column(u'dashboard_dashboardrangestatusweekly', 'reference_name')

        # Deleting field 'DashboardRangeStatusHourly.reference_name'
        db.delete_column(u'dashboard_dashboardrangestatushourly', 'reference_name')

        # Deleting field 'DashboardRangeStatusTimely.reference_name'
        db.delete_column(u'dashboard_dashboardrangestatustimely', 'reference_name')

        # Deleting field 'DashboardRangeStatusYearly.reference_name'
        db.delete_column(u'dashboard_dashboardrangestatusyearly', 'reference_name')
