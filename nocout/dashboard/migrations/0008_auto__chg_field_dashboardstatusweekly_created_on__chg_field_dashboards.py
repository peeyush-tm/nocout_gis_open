...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DashboardStatusWeekly.created_on'
        db.alter_column(u'dashboard_dashboardstatusweekly', 'created_on', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'DashboardStatusMonthly.created_on'
        db.alter_column(u'dashboard_dashboardstatusmonthly', 'created_on', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'DashboardStatusDaily.created_on'
        db.alter_column(u'dashboard_dashboardstatusdaily', 'created_on', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'DashboardStatusTimely.created_on'
        db.alter_column(u'dashboard_dashboardstatustimely', 'created_on', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'DashboardStatusHourly.created_on'
        db.alter_column(u'dashboard_dashboardstatushourly', 'created_on', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'DashboardStatusYearly.created_on'
        db.alter_column(u'dashboard_dashboardstatusyearly', 'created_on', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'DashboardStatusWeekly.created_on'
        db.alter_column(u'dashboard_dashboardstatusweekly', 'created_on', self.gf('django.db.models.fields.DateField')())

        # Changing field 'DashboardStatusMonthly.created_on'
        db.alter_column(u'dashboard_dashboardstatusmonthly', 'created_on', self.gf('django.db.models.fields.DateField')())

        # Changing field 'DashboardStatusDaily.created_on'
        db.alter_column(u'dashboard_dashboardstatusdaily', 'created_on', self.gf('django.db.models.fields.DateField')())

        # Changing field 'DashboardStatusTimely.created_on'
        db.alter_column(u'dashboard_dashboardstatustimely', 'created_on', self.gf('django.db.models.fields.DateField')())

        # Changing field 'DashboardStatusHourly.created_on'
        db.alter_column(u'dashboard_dashboardstatushourly', 'created_on', self.gf('django.db.models.fields.DateField')())

        # Changing field 'DashboardStatusYearly.created_on'
        db.alter_column(u'dashboard_dashboardstatusyearly', 'created_on', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'dashboard.dashboardstatusdaily': {
            'Meta': {'object_name': 'DashboardStatusDaily'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {}),
            'dashboard_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'end_range': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'range_color': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
            'range_count': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'range_type': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            'start_range': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        u'dashboard.dashboardstatushourly': {
            'Meta': {'object_name': 'DashboardStatusHourly'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {}),
            'dashboard_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'end_range': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.dashboardstatusmonthly': {
            'Meta': {'object_name': 'DashboardStatusMonthly'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {}),
            'dashboard_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'end_range': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.dashboardstatustimely': {
            'Meta': {'object_name': 'DashboardStatusTimely'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {}),
            'dashboard_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'end_range': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.dashboardstatusweekly': {
            'Meta': {'object_name': 'DashboardStatusWeekly'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {}),
            'dashboard_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'end_range': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dashboard.dashboardstatusyearly': {
            'Meta': {'object_name': 'DashboardStatusYearly'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {}),
            'dashboard_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'end_range': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
