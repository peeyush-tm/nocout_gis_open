...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DashboardSetting.is_bh'
        db.add_column(u'dashboard_dashboardsetting', 'is_bh',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding unique constraint on 'DashboardSetting', fields ['name', 'page_name', 'technology', 'is_bh']
        db.create_unique(u'dashboard_dashboardsetting', ['name', 'page_name', 'technology_id', 'is_bh'])


    def backwards(self, orm):
        # Removing unique constraint on 'DashboardSetting', fields ['name', 'page_name', 'technology', 'is_bh']
        db.delete_unique(u'dashboard_dashboardsetting', ['name', 'page_name', 'technology_id', 'is_bh'])

        # Deleting field 'DashboardSetting.is_bh'
        db.delete_column(u'dashboard_dashboardsetting', 'is_bh')
