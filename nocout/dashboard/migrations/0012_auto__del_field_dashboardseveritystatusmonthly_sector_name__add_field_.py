...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DashboardSeverityStatusMonthly.sector_name'
        db.delete_column(u'dashboard_dashboardseveritystatusmonthly', 'sector_name')

        # Adding field 'DashboardSeverityStatusMonthly.device_name'
        db.add_column(u'dashboard_dashboardseveritystatusmonthly', 'device_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Adding field 'DashboardSeverityStatusMonthly.reference_name'
        db.add_column(u'dashboard_dashboardseveritystatusmonthly', 'reference_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Deleting field 'DashboardSeverityStatusTimely.sector_name'
        db.delete_column(u'dashboard_dashboardseveritystatustimely', 'sector_name')

        # Adding field 'DashboardSeverityStatusTimely.device_name'
        db.add_column(u'dashboard_dashboardseveritystatustimely', 'device_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Adding field 'DashboardSeverityStatusTimely.reference_name'
        db.add_column(u'dashboard_dashboardseveritystatustimely', 'reference_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Deleting field 'DashboardSeverityStatusHourly.sector_name'
        db.delete_column(u'dashboard_dashboardseveritystatushourly', 'sector_name')

        # Adding field 'DashboardSeverityStatusHourly.device_name'
        db.add_column(u'dashboard_dashboardseveritystatushourly', 'device_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Adding field 'DashboardSeverityStatusHourly.reference_name'
        db.add_column(u'dashboard_dashboardseveritystatushourly', 'reference_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Deleting field 'DashboardSeverityStatusYearly.sector_name'
        db.delete_column(u'dashboard_dashboardseveritystatusyearly', 'sector_name')

        # Adding field 'DashboardSeverityStatusYearly.device_name'
        db.add_column(u'dashboard_dashboardseveritystatusyearly', 'device_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Adding field 'DashboardSeverityStatusYearly.reference_name'
        db.add_column(u'dashboard_dashboardseveritystatusyearly', 'reference_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Deleting field 'DashboardSeverityStatusWeekly.sector_name'
        db.delete_column(u'dashboard_dashboardseveritystatusweekly', 'sector_name')

        # Adding field 'DashboardSeverityStatusWeekly.device_name'
        db.add_column(u'dashboard_dashboardseveritystatusweekly', 'device_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Adding field 'DashboardSeverityStatusWeekly.reference_name'
        db.add_column(u'dashboard_dashboardseveritystatusweekly', 'reference_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Deleting field 'DashboardSeverityStatusDaily.sector_name'
        db.delete_column(u'dashboard_dashboardseveritystatusdaily', 'sector_name')

        # Adding field 'DashboardSeverityStatusDaily.device_name'
        db.add_column(u'dashboard_dashboardseveritystatusdaily', 'device_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Adding field 'DashboardSeverityStatusDaily.reference_name'
        db.add_column(u'dashboard_dashboardseveritystatusdaily', 'reference_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DashboardSeverityStatusMonthly.sector_name'
        db.add_column(u'dashboard_dashboardseveritystatusmonthly', 'sector_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Deleting field 'DashboardSeverityStatusMonthly.device_name'
        db.delete_column(u'dashboard_dashboardseveritystatusmonthly', 'device_name')

        # Deleting field 'DashboardSeverityStatusMonthly.reference_name'
        db.delete_column(u'dashboard_dashboardseveritystatusmonthly', 'reference_name')

        # Adding field 'DashboardSeverityStatusTimely.sector_name'
        db.add_column(u'dashboard_dashboardseveritystatustimely', 'sector_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Deleting field 'DashboardSeverityStatusTimely.device_name'
        db.delete_column(u'dashboard_dashboardseveritystatustimely', 'device_name')

        # Deleting field 'DashboardSeverityStatusTimely.reference_name'
        db.delete_column(u'dashboard_dashboardseveritystatustimely', 'reference_name')

        # Adding field 'DashboardSeverityStatusHourly.sector_name'
        db.add_column(u'dashboard_dashboardseveritystatushourly', 'sector_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Deleting field 'DashboardSeverityStatusHourly.device_name'
        db.delete_column(u'dashboard_dashboardseveritystatushourly', 'device_name')

        # Deleting field 'DashboardSeverityStatusHourly.reference_name'
        db.delete_column(u'dashboard_dashboardseveritystatushourly', 'reference_name')

        # Adding field 'DashboardSeverityStatusYearly.sector_name'
        db.add_column(u'dashboard_dashboardseveritystatusyearly', 'sector_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Deleting field 'DashboardSeverityStatusYearly.device_name'
        db.delete_column(u'dashboard_dashboardseveritystatusyearly', 'device_name')

        # Deleting field 'DashboardSeverityStatusYearly.reference_name'
        db.delete_column(u'dashboard_dashboardseveritystatusyearly', 'reference_name')

        # Adding field 'DashboardSeverityStatusWeekly.sector_name'
        db.add_column(u'dashboard_dashboardseveritystatusweekly', 'sector_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Deleting field 'DashboardSeverityStatusWeekly.device_name'
        db.delete_column(u'dashboard_dashboardseveritystatusweekly', 'device_name')

        # Deleting field 'DashboardSeverityStatusWeekly.reference_name'
        db.delete_column(u'dashboard_dashboardseveritystatusweekly', 'reference_name')

        # Adding field 'DashboardSeverityStatusDaily.sector_name'
        db.add_column(u'dashboard_dashboardseveritystatusdaily', 'sector_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=100, db_index=True),
                      keep_default=False)

        # Deleting field 'DashboardSeverityStatusDaily.device_name'
        db.delete_column(u'dashboard_dashboardseveritystatusdaily', 'device_name')

        # Deleting field 'DashboardSeverityStatusDaily.reference_name'
        db.delete_column(u'dashboard_dashboardseveritystatusdaily', 'reference_name')
