...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DashboardStatusWeekly.range_color'
        db.add_column(u'dashboard_dashboardstatusweekly', 'range_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'DashboardStatusMonthly.range_color'
        db.add_column(u'dashboard_dashboardstatusmonthly', 'range_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'DashboardStatusDaily.range_color'
        db.add_column(u'dashboard_dashboardstatusdaily', 'range_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'DashboardStatusTimely.range_color'
        db.add_column(u'dashboard_dashboardstatustimely', 'range_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'DashboardStatusHourly.range_color'
        db.add_column(u'dashboard_dashboardstatushourly', 'range_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'DashboardStatusYearly.range_color'
        db.add_column(u'dashboard_dashboardstatusyearly', 'range_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DashboardStatusWeekly.range_color'
        db.delete_column(u'dashboard_dashboardstatusweekly', 'range_color')

        # Deleting field 'DashboardStatusMonthly.range_color'
        db.delete_column(u'dashboard_dashboardstatusmonthly', 'range_color')

        # Deleting field 'DashboardStatusDaily.range_color'
        db.delete_column(u'dashboard_dashboardstatusdaily', 'range_color')

        # Deleting field 'DashboardStatusTimely.range_color'
        db.delete_column(u'dashboard_dashboardstatustimely', 'range_color')

        # Deleting field 'DashboardStatusHourly.range_color'
        db.delete_column(u'dashboard_dashboardstatushourly', 'range_color')

        # Deleting field 'DashboardStatusYearly.range_color'
        db.delete_column(u'dashboard_dashboardstatusyearly', 'range_color')
