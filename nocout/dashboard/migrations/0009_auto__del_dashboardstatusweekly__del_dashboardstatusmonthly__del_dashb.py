...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'DashboardStatusWeekly'
        db.delete_table(u'dashboard_dashboardstatusweekly')

        # Deleting model 'DashboardStatusMonthly'
        db.delete_table(u'dashboard_dashboardstatusmonthly')

        # Deleting model 'DashboardStatusDaily'
        db.delete_table(u'dashboard_dashboardstatusdaily')

        # Deleting model 'DashboardStatusTimely'
        db.delete_table(u'dashboard_dashboardstatustimely')

        # Deleting model 'DashboardStatusHourly'
        db.delete_table(u'dashboard_dashboardstatushourly')

        # Deleting model 'DashboardStatusYearly'
        db.delete_table(u'dashboard_dashboardstatusyearly')

        # Adding model 'DashboardRangeStatusMonthly'
        db.create_table(u'dashboard_dashboardrangestatusmonthly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dashboard_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('device_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')()),
            ('range1', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('range2', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('range3', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('range4', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('range5', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('range6', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('range7', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('range8', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('range9', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('range10', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('unknown', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'dashboard', ['DashboardRangeStatusMonthly'])

        # Adding model 'DashboardRangeStatusDaily'
        db.create_table(u'dashboard_dashboardrangestatusdaily', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dashboard_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('device_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal(u'dashboard', ['DashboardRangeStatusDaily'])

        # Adding model 'DashboardRangeStatusWeekly'
        db.create_table(u'dashboard_dashboardrangestatusweekly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dashboard_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('device_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal(u'dashboard', ['DashboardRangeStatusWeekly'])

        # Adding model 'DashboardRangeStatusHourly'
        db.create_table(u'dashboard_dashboardrangestatushourly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dashboard_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('device_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal(u'dashboard', ['DashboardRangeStatusHourly'])

        # Adding model 'DashboardRangeStatusTimely'
        db.create_table(u'dashboard_dashboardrangestatustimely', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dashboard_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('device_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal(u'dashboard', ['DashboardRangeStatusTimely'])

        # Adding model 'DashboardRangeStatusYearly'
        db.create_table(u'dashboard_dashboardrangestatusyearly', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dashboard_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('device_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')()),
        ...
        db.send_create_signal(u'dashboard', ['DashboardRangeStatusYearly'])


    def backwards(self, orm):
        # Adding model 'DashboardStatusWeekly'
        db.create_table(u'dashboard_dashboardstatusweekly', (
            ('dashboard_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('end_range', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')()),
            ('range_count', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('start_range', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('range_type', self.gf('django.db.models.fields.CharField')(max_length=3)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('range_color', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
        ))
        db.send_create_signal(u'dashboard', ['DashboardStatusWeekly'])

        # Adding model 'DashboardStatusMonthly'
        db.create_table(u'dashboard_dashboardstatusmonthly', (
            ('dashboard_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('end_range', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')()),
            ('range_count', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ...
        db.send_create_signal(u'dashboard', ['DashboardStatusMonthly'])

        # Adding model 'DashboardStatusDaily'
        db.create_table(u'dashboard_dashboardstatusdaily', (
            ('dashboard_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('end_range', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')()),
            ('range_count', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ...
        db.send_create_signal(u'dashboard', ['DashboardStatusDaily'])

        # Adding model 'DashboardStatusTimely'
        db.create_table(u'dashboard_dashboardstatustimely', (
            ('dashboard_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('end_range', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')()),
            ('range_count', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ...
        db.send_create_signal(u'dashboard', ['DashboardStatusTimely'])

        # Adding model 'DashboardStatusHourly'
        db.create_table(u'dashboard_dashboardstatushourly', (
            ('dashboard_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('end_range', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')()),
            ('range_count', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ...
        db.send_create_signal(u'dashboard', ['DashboardStatusHourly'])

        # Adding model 'DashboardStatusYearly'
        db.create_table(u'dashboard_dashboardstatusyearly', (
            ('dashboard_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('end_range', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')()),
            ('range_count', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ...
        db.send_create_signal(u'dashboard', ['DashboardStatusYearly'])

        # Deleting model 'DashboardRangeStatusMonthly'
        db.delete_table(u'dashboard_dashboardrangestatusmonthly')

        # Deleting model 'DashboardRangeStatusDaily'
        db.delete_table(u'dashboard_dashboardrangestatusdaily')

        # Deleting model 'DashboardRangeStatusWeekly'
        db.delete_table(u'dashboard_dashboardrangestatusweekly')

        # Deleting model 'DashboardRangeStatusHourly'
        db.delete_table(u'dashboard_dashboardrangestatushourly')

        # Deleting model 'DashboardRangeStatusTimely'
        db.delete_table(u'dashboard_dashboardrangestatustimely')

        # Deleting model 'DashboardRangeStatusYearly'
        db.delete_table(u'dashboard_dashboardrangestatusyearly')
