...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DashboardSetting.technology'
        db.alter_column(u'dashboard_dashboardsetting', 'technology_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.DeviceTechnology'], null=True))

    def backwards(self, orm):

        # Changing field 'DashboardSetting.technology'
        db.alter_column(u'dashboard_dashboardsetting', 'technology_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['device.DeviceTechnology']))
