...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DFRProcessed'
        db.create_table(u'dashboard_dfrprocessed', (
            ...
            ('processed_report_path', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'dashboard', ['DFRProcessed'])

        # Adding model 'MFRDFRReports'
        db.create_table(u'dashboard_mfrdfrreports', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('is_processed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('process_for', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now, blank=True)),
            ('upload_to', self.gf('django.db.models.fields.files.FileField')(max_length=512)),
            ('absolute_path', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'dashboard', ['MFRDFRReports'])

        # Adding model 'MFRProcessed'
        db.create_table(u'dashboard_mfrprocessed', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('processed_for', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.MFRDFRReports'])),
            ('processed_on', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now, blank=True)),
            ('processed_key', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ...
        db.send_create_signal(u'dashboard', ['MFRProcessed'])


    def backwards(self, orm):
        # Deleting model 'DFRProcessed'
        db.delete_table(u'dashboard_dfrprocessed')

        # Deleting model 'MFRDFRReports'
        db.delete_table(u'dashboard_mfrdfrreports')

        # Deleting model 'MFRProcessed'
        db.delete_table(u'dashboard_mfrprocessed')
