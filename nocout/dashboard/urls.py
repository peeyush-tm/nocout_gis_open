...
urlpatterns = patterns('',
                       ...
                       url(r'^packet_loss/wimax/$',
                           views.DashboardDeviceStatus.as_view(),
                           name='packet-loss-wimax'),
                       url(r'^packet_loss/pmp/$',
                           views.DashboardDeviceStatus.as_view(),
                           name='packet-loss-pmp'),
                       url(r'^packet_loss/all/$',
                           views.DashboardDeviceStatus.as_view(),
                       ...
                       url(r'^temperature-idu/wimax/$',
                           views.DashboardDeviceStatus.as_view(),
                           name='temperatue-idu-wimax'),
                       url(r'^temperature-acb/wimax/$',
                           views.DashboardDeviceStatus.as_view(),
                           name='temperatue-acb-wimax'),
                       url(r'^temperature-fan/wimax/$',
                           views.DashboardDeviceStatus.as_view(),
                           name='temperatue-fan-wimax'),

                       url(r'^cause-code/mfr/$',
