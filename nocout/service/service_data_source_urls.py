...
urlpatterns = patterns('',
  ...
  url(r'^edit/(?P<pk>\d+)$', views.ServiceDataSourceUpdate.as_view(), name='service_data_source_edit'),
  url(r'^delete/(?P<pk>\d+)$', views.ServiceDataSourceDelete.as_view(), name='service_data_source_delete'),
