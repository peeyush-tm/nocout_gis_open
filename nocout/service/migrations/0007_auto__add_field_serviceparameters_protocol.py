...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServiceParameters.protocol'
        db.add_column(u'service_serviceparameters', 'protocol',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.Protocol'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServiceParameters.protocol'
        db.delete_column(u'service_serviceparameters', 'protocol_id')
