...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceServiceConfiguration.is_added'
        db.add_column(u'service_deviceserviceconfiguration', 'is_added',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceServiceConfiguration.is_added'
        db.delete_column(u'service_deviceserviceconfiguration', 'is_added')
