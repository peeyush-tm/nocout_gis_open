...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'service_protocol', (
            ...
            ('read_community', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.create_table(u'service_serviceparameters', (
            ...
            ('protocol', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.Protocol'])),
            ('normal_check_interval', self.gf('django.db.models.fields.IntegerField')()),
            ('retry_check_interval', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.create_table(u'service_service', (
            ...
            ('parameters', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.ServiceParameters'])),
        ...
        # Adding model 'DeviceServiceConfiguration'
        db.create_table(u'service_deviceserviceconfiguration', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('svc_template', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DeviceServiceConfiguration'
        db.delete_table(u'service_deviceserviceconfiguration')
