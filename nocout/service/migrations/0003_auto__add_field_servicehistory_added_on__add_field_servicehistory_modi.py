...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServiceHistory.added_on'
        db.add_column(u'service_servicehistory', 'added_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ServiceHistory.modified_on'
        db.add_column(u'service_servicehistory', 'modified_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Service.parameters'
        db.alter_column(u'service_service', 'parameters_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['service.ServiceParameters']))

        # Changing field 'Protocol.read_community'
        db.alter_column(u'service_protocol', 'read_community', self.gf('django.db.models.fields.CharField')(default=1, max_length=100))

        # Changing field 'Protocol.port'
        db.alter_column(u'service_protocol', 'port', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'Protocol.version'
        db.alter_column(u'service_protocol', 'version', self.gf('django.db.models.fields.CharField')(default=1, max_length=10))

        # Changing field 'ServiceParameters.protocol'
        db.alter_column(u'service_serviceparameters', 'protocol_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['service.Protocol']))

        # Changing field 'ServiceParameters.retry_check_interval'
        db.alter_column(u'service_serviceparameters', 'retry_check_interval', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'ServiceParameters.normal_check_interval'
        db.alter_column(u'service_serviceparameters', 'normal_check_interval', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'ServiceParameters.max_check_attempts'
        db.alter_column(u'service_serviceparameters', 'max_check_attempts', self.gf('django.db.models.fields.IntegerField')(default=1))

    def backwards(self, orm):
        # Deleting field 'ServiceHistory.added_on'
        db.delete_column(u'service_servicehistory', 'added_on')

        # Deleting field 'ServiceHistory.modified_on'
        db.delete_column(u'service_servicehistory', 'modified_on')


        # Changing field 'Service.parameters'
        db.alter_column(u'service_service', 'parameters_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.ServiceParameters'], null=True))

        # Changing field 'Protocol.read_community'
        db.alter_column(u'service_protocol', 'read_community', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Protocol.port'
        db.alter_column(u'service_protocol', 'port', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Protocol.version'
        db.alter_column(u'service_protocol', 'version', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'ServiceParameters.protocol'
        db.alter_column(u'service_serviceparameters', 'protocol_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.Protocol'], null=True))

        # Changing field 'ServiceParameters.retry_check_interval'
        db.alter_column(u'service_serviceparameters', 'retry_check_interval', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ServiceParameters.normal_check_interval'
        db.alter_column(u'service_serviceparameters', 'normal_check_interval', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ServiceParameters.max_check_attempts'
        db.alter_column(u'service_serviceparameters', 'max_check_attempts', self.gf('django.db.models.fields.IntegerField')(null=True))
