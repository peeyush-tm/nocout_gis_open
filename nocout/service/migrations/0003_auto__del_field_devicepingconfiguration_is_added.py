...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DevicePingConfiguration.is_added'
        db.delete_column(u'service_devicepingconfiguration', 'is_added')


    def backwards(self, orm):
        # Adding field 'DevicePingConfiguration.is_added'
        db.add_column(u'service_devicepingconfiguration', 'is_added',
