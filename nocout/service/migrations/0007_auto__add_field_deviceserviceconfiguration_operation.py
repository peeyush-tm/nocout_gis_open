...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceServiceConfiguration.operation'
        db.add_column(u'service_deviceserviceconfiguration', 'operation',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceServiceConfiguration.operation'
        db.delete_column(u'service_deviceserviceconfiguration', 'operation')
    ...
    models = {
        ...
        u'service.deviceserviceconfiguration': {
            ...
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'normal_check_interval': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'operation': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
