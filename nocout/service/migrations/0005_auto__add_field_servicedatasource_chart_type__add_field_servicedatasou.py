...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ServiceDataSource.chart_type'
        db.add_column(u'service_servicedatasource', 'chart_type',
                      self.gf('django.db.models.fields.CharField')(default='pie', max_length=50),
                      keep_default=False)

        # Adding field 'ServiceDataSource.formula'
        db.add_column(u'service_servicedatasource', 'formula',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ServiceDataSource.valuesuffix'
        db.add_column(u'service_servicedatasource', 'valuesuffix',
                      self.gf('django.db.models.fields.CharField')(default='seconds', max_length=100),
                      keep_default=False)

        # Adding field 'ServiceDataSource.valuetext'
        db.add_column(u'service_servicedatasource', 'valuetext',
                      self.gf('django.db.models.fields.CharField')(default='seconds', max_length=100),
                      keep_default=False)

        # Adding field 'ServiceDataSource.show_min'
        db.add_column(u'service_servicedatasource', 'show_min',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ServiceDataSource.show_max'
        db.add_column(u'service_servicedatasource', 'show_max',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ServiceDataSource.show_gis'
        db.add_column(u'service_servicedatasource', 'show_gis',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ServiceDataSource.data_source_type'
        db.add_column(u'service_servicedatasource', 'data_source_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'ServiceDataSource.chart_color'
        db.add_column(u'service_servicedatasource', 'chart_color',
                      self.gf('django.db.models.fields.CharField')(default='#FAFAFA', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ServiceDataSource.chart_type'
        db.delete_column(u'service_servicedatasource', 'chart_type')

        # Deleting field 'ServiceDataSource.formula'
        db.delete_column(u'service_servicedatasource', 'formula')

        # Deleting field 'ServiceDataSource.valuesuffix'
        db.delete_column(u'service_servicedatasource', 'valuesuffix')

        # Deleting field 'ServiceDataSource.valuetext'
        db.delete_column(u'service_servicedatasource', 'valuetext')

        # Deleting field 'ServiceDataSource.show_min'
        db.delete_column(u'service_servicedatasource', 'show_min')

        # Deleting field 'ServiceDataSource.show_max'
        db.delete_column(u'service_servicedatasource', 'show_max')

        # Deleting field 'ServiceDataSource.show_gis'
        db.delete_column(u'service_servicedatasource', 'show_gis')

        # Deleting field 'ServiceDataSource.data_source_type'
        db.delete_column(u'service_servicedatasource', 'data_source_type')

        # Deleting field 'ServiceDataSource.chart_color'
        db.delete_column(u'service_servicedatasource', 'chart_color')
    ...
    models = {
        ...
        u'service.servicedatasource': {
            ...
            'data_source_type': ('django.db.models.fields.IntegerField', [], {}),
            'formula': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'show_gis': ('django.db.models.fields.BooleanField', [], {}),
            'show_max': ('django.db.models.fields.BooleanField', [], {}),
            'show_min': ('django.db.models.fields.BooleanField', [], {}),
