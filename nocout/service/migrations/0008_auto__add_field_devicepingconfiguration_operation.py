...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DevicePingConfiguration.operation'
        db.add_column(u'service_devicepingconfiguration', 'operation',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DevicePingConfiguration.operation'
        db.delete_column(u'service_devicepingconfiguration', 'operation')
