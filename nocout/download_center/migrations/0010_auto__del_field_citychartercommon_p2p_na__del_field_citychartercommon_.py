...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CityCharterCommon.p2p_na'
        db.delete_column(u'download_center_citychartercommon', 'p2p_na')

        # Deleting field 'CityCharterCommon.p2p_rogue_ss'
        db.delete_column(u'download_center_citychartercommon', 'p2p_rogue_ss')

        # Deleting field 'CityCharterCommon.pmp_rogue_ss'
        db.delete_column(u'download_center_citychartercommon', 'pmp_rogue_ss')

        # Deleting field 'CityCharterCommon.pmp_na'
        db.delete_column(u'download_center_citychartercommon', 'pmp_na')


    def backwards(self, orm):
        # Adding field 'CityCharterCommon.p2p_na'
        db.add_column(u'download_center_citychartercommon', 'p2p_na',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CityCharterCommon.p2p_rogue_ss'
        db.add_column(u'download_center_citychartercommon', 'p2p_rogue_ss',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CityCharterCommon.pmp_rogue_ss'
        db.add_column(u'download_center_citychartercommon', 'pmp_rogue_ss',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CityCharterCommon.pmp_na'
        db.add_column(u'download_center_citychartercommon', 'pmp_na',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)
