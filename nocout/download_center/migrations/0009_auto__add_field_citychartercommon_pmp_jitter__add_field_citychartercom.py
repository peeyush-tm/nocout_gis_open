...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CityCharterCommon.pmp_jitter'
        db.add_column(u'download_center_citychartercommon', 'pmp_jitter',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CityCharterCommon.pmp_rereg'
        db.add_column(u'download_center_citychartercommon', 'pmp_rereg',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CityCharterCommon.p2p_uas'
        db.add_column(u'download_center_citychartercommon', 'p2p_uas',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CityCharterCommon.pmp_jitter'
        db.delete_column(u'download_center_citychartercommon', 'pmp_jitter')

        # Deleting field 'CityCharterCommon.pmp_rereg'
        db.delete_column(u'download_center_citychartercommon', 'pmp_rereg')

        # Deleting field 'CityCharterCommon.p2p_uas'
        db.delete_column(u'download_center_citychartercommon', 'p2p_uas')
