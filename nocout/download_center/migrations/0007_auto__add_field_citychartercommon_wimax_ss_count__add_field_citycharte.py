...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CityCharterCommon.wimax_ss_count'
        db.add_column(u'download_center_citychartercommon', 'wimax_ss_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CityCharterCommon.wimax_ss_percentage'
        db.add_column(u'download_center_citychartercommon', 'wimax_ss_percentage',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'CityCharterCommon.pmp_ss_count'
        db.add_column(u'download_center_citychartercommon', 'pmp_ss_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CityCharterCommon.pmp_ss_percentage'
        db.add_column(u'download_center_citychartercommon', 'pmp_ss_percentage',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'CityCharterCommon.p2p_ss_count'
        db.add_column(u'download_center_citychartercommon', 'p2p_ss_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CityCharterCommon.p2p_ss_percentage'
        db.add_column(u'download_center_citychartercommon', 'p2p_ss_percentage',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CityCharterCommon.wimax_ss_count'
        db.delete_column(u'download_center_citychartercommon', 'wimax_ss_count')

        # Deleting field 'CityCharterCommon.wimax_ss_percentage'
        db.delete_column(u'download_center_citychartercommon', 'wimax_ss_percentage')

        # Deleting field 'CityCharterCommon.pmp_ss_count'
        db.delete_column(u'download_center_citychartercommon', 'pmp_ss_count')

        # Deleting field 'CityCharterCommon.pmp_ss_percentage'
        db.delete_column(u'download_center_citychartercommon', 'pmp_ss_percentage')

        # Deleting field 'CityCharterCommon.p2p_ss_count'
        db.delete_column(u'download_center_citychartercommon', 'p2p_ss_count')

        # Deleting field 'CityCharterCommon.p2p_ss_percentage'
        db.delete_column(u'download_center_citychartercommon', 'p2p_ss_percentage')
