...
class BSOutageMasterStructure(models.Model):
    ...
    total_affected_bs = models.CharField('Number of BS Affected', max_length=100)
    ...
    bs_ip = models.CharField('BS IP Address', max_length=150)
    bs_sw_version = models.CharField('BS Software Version', max_length=100)
    total_affected_sector = models.CharField('Number of Sectors Affected', max_length=100)
    switch_reachability = models.CharField('Switch Reachability', max_length=150)
    outage_timestamp = models.CharField('Outage Date And Time', max_length=150, null=True, blank=True)
    restored_timestamp = models.CharField('Restored Date And Time', max_length=150, null=True, blank=True)
    alarm_restored_timestamp = models.CharField('Alarm Restored Date And Time', max_length=150, null=True, blank=True)
    outage_min_per_site = models.CharField('Outage Per Site(Min.)', max_length=100)
    mttr_hrs = models.CharField('MTTR Hrs', max_length=100)
    mttr = models.CharField('MTTR', max_length=150)
    outage_total_min = models.CharField('Outage Total(Min.)', max_length=100)
    alarm_outage_min = models.CharField('Alarm Outage(Min.)', max_length=100)
    total_affected_enterprise_ss = models.CharField('Number of Enterprise SS Affected', max_length=100)
    total_affected_retail_ss = models.CharField('Number of Retail SS Affected', max_length=100)
    ...
    tac_tt_number = models.CharField('Tac TT Number', max_length=100)
    ...
    delay = models.CharField('Delay', max_length=100)
    ...
    fault_description = models.CharField('Remark/Detail Fault Description', max_length=255, null=True, blank=True)
    ...
    spot_cases = models.CharField('Spot Cases', max_length=100)
    fault_history = models.CharField('Fault History', max_length=255, null=True, blank=True)
...
class BSOutageFaultStructure(models.Model):
    ...
    fault_type = models.CharField('Type of Fault', max_length=100)
    outage_min_per_site = models.CharField('Outage Per Site(Min.)', max_length=100)
    outage_count = models.CharField('Outage Count', max_length=100)
    uploaded_at = models.DateTimeField('Uploaded At', auto_now_add=True, blank=True)
...
class BSOutageMTTRProcessed(models.Model):
    ...
    processed_on = models.CharField('Processed Date and Time', max_length=150)
