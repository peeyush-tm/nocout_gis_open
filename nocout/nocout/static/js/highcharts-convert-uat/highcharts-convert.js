...
(function () {
	...
	var config = {
			 ...
			 */
			files: { 
				JQUERY: '/omd/tmp/static/js/jquery/jquery-1.11.1.min.js',
				HIGHCHARTS: '/omd/tmp/static/js/highcharts.js',
				HIGHCHARTS_THEME: '/omd/tmp/static/js/highcharttheme.js',
				HIGHCHARTS_MORE: '/omd/tmp/static/js/highcharts-more.js',
				HIGHCHARTS_NODATA: '/omd/tmp/static/js/no-data-to-display.js'
			},
