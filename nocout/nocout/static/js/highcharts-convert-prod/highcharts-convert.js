...
(function () {
	...
	var config = {
			 ...
			 */
			files: { 
				JQUERY: '/apps/tmp/static/js/jquery/jquery-1.11.1.min.js',
				HIGHCHARTS: '/apps/tmp/static/js/highcharts.js',
				HIGHCHARTS_THEME: '/apps/tmp/static/js/highcharttheme.js',
				HIGHCHARTS_MORE: '/apps/tmp/static/js/highcharts-more.js',
				HIGHCHARTS_NODATA: '/apps/tmp/static/js/no-data-to-display.js'
			},
