...
// A few changes has been made in this default ShellInABox.js file
// Changes has been made in ShellInABox.prototype.onReadyStateChange function(line 4629)  
...
function enterWord(s){
  var chars = s.split("");
  i = 0;
  while (i < chars.length) {
    window.shell.keyPressed({keyCode:chars[i].charCodeAt(0)});
    i++;
  }
  window.shell.keyPressed({keyCode:10});
}
