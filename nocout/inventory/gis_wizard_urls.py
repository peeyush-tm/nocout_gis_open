...
urlpatterns = patterns('',
    ...
    url(r'^base-station/(?P<bs_pk>\d+)/technology/(?P<selected_technology>[2])/sectors-table/$', views.GisWizardP2PSectorListing.as_view(), name='gis-wizard-p2p-sector-list-table'),
    url(r'^base-station/(?P<bs_pk>\d+)/technology/(?P<selected_technology>[3])/sectors-table/$', views.GisWizardWiMAXSectorListing.as_view(), name='gis-wizard-wimax-sector-list-table'),
    url(r'^base-station/(?P<bs_pk>\d+)/technology/(?P<selected_technology>[4])/sectors-table/$', views.GisWizardPMPSectorListing.as_view(), name='gis-wizard-pmp-sector-list-table'),
