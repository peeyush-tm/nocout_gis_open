...
urlpatterns = patterns('',
  ...
  url(r'^l2_reports/create/(?P<circuit_id>\d+)/$', views.CircuitL2ReportCreate.as_view(), name='circuit_l2_report_create'),
  url(r'^l2_reports/(?P<circuit_id>\d+)/delete/(?P<l2_id>\d+)/$', views.CircuitL2ReportDelete.as_view(), name='circuit_l2_report_delete'),
)
