...
urlpatterns = patterns('',
  ...
  url(r'^(?P<type>((?!new)..)[a-z]+)/$', views.ThematicSettingsList.as_view(), name='thematic_settings_list'),
  ...
  url(r'^ThematicSettingslistingtable/(?P<technology>\w+)$', views.ThematicSettingsListingTable.as_view(), name='ThematicSettingsListingTable'),
