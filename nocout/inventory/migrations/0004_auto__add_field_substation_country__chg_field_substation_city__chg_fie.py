...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubStation.country'
        db.add_column(u'inventory_substation', 'country',
    ...
    def backwards(self, orm):
        # Deleting field 'SubStation.country'
        db.delete_column(u'inventory_substation', 'country')


        # Changing field 'SubStation.city'
        db.alter_column(u'inventory_substation', 'city', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'SubStation.state'
        db.alter_column(u'inventory_substation', 'state', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
