...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GISExcelDownload.downloaded_by'
        db.add_column(u'inventory_gisexceldownload', 'downloaded_by',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GISExcelDownload.downloaded_by'
        db.delete_column(u'inventory_gisexceldownload', 'downloaded_by')
