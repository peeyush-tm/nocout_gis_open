...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'inventory_thematicsettings', (
            ...
            ('icon_settings', self.gf('django.db.models.fields.TextField')(default='NULL')),
        ))
        db.send_create_signal(u'inventory', ['ThematicSettings'])

        # Adding M2M table for field user on 'ThematicSettings'
        m2m_table_name = db.shorten_name(u'inventory_thematicsettings_user')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field user on 'ThematicSettings'
        db.delete_table(db.shorten_name(u'inventory_thematicsettings_user'))
    ...
    models = {
        ...
        u'inventory.thematicsettings': {
            ...
            'user': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['user_profile.UserProfile']", 'symmetrical': 'False'})
        },
