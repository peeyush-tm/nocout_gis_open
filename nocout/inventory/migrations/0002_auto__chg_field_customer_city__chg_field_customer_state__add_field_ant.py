...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inventory_customer', 'city', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Customer.state'
        db.alter_column(u'inventory_customer', 'state', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
        # Adding field 'Antenna.gain'
        db.add_column(u'inventory_antenna', 'gain',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Antenna.mount_type'
        db.add_column(u'inventory_antenna', 'mount_type',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Backhaul.bh_switch'
        db.add_column(u'inventory_backhaul', 'bh_switch',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='backhaul_switch', null=True, to=orm['device.Device']),
                      keep_default=False)

        # Adding field 'Backhaul.switch_port'
        db.add_column(u'inventory_backhaul', 'switch_port',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.idu_type'
        db.add_column(u'inventory_sector', 'idu_type',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.rx_power'
        db.add_column(u'inventory_sector', 'rx_power',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.rf_bandwidth'
        db.add_column(u'inventory_sector', 'rf_bandwidth',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.modulation'
        db.add_column(u'inventory_sector', 'modulation',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.city'
        db.add_column(u'inventory_sector', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.state'
        db.add_column(u'inventory_sector', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.address'
        db.add_column(u'inventory_sector', 'address',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SubStation.ip'
        db.delete_column(u'inventory_substation', 'ip')

        # Deleting field 'SubStation.longitude'
        db.delete_column(u'inventory_substation', 'longitude')

        # Deleting field 'SubStation.mac'
        db.delete_column(u'inventory_substation', 'mac')

        # Deleting field 'SubStation.latitude'
        db.delete_column(u'inventory_substation', 'latitude')

        # Adding field 'SubStation.version'
        db.add_column(u'inventory_substation', 'version',
        ...
        # Adding field 'Circuit.circuit_type'
        db.add_column(u'inventory_circuit', 'circuit_type',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Customer.city'
        db.alter_column(u'inventory_customer', 'city', self.gf('django.db.models.fields.CharField')(default=1, max_length=250))

        # Changing field 'Customer.state'
        db.alter_column(u'inventory_customer', 'state', self.gf('django.db.models.fields.CharField')(default=1, max_length=250))
        # Deleting field 'Antenna.gain'
        db.delete_column(u'inventory_antenna', 'gain')

        # Deleting field 'Antenna.mount_type'
        db.delete_column(u'inventory_antenna', 'mount_type')

        # Deleting field 'Backhaul.bh_switch'
        db.delete_column(u'inventory_backhaul', 'bh_switch_id')

        # Deleting field 'Backhaul.switch_port'
        db.delete_column(u'inventory_backhaul', 'switch_port')

        # Deleting field 'Sector.idu_type'
        db.delete_column(u'inventory_sector', 'idu_type')

        # Deleting field 'Sector.rx_power'
        db.delete_column(u'inventory_sector', 'rx_power')

        # Deleting field 'Sector.rf_bandwidth'
        db.delete_column(u'inventory_sector', 'rf_bandwidth')

        # Deleting field 'Sector.modulation'
        db.delete_column(u'inventory_sector', 'modulation')

        # Deleting field 'Sector.city'
        db.delete_column(u'inventory_sector', 'city')

        # Deleting field 'Sector.state'
        db.delete_column(u'inventory_sector', 'state')

        # Deleting field 'Sector.address'
        db.delete_column(u'inventory_sector', 'address')

        # Adding field 'SubStation.ip'
        db.add_column(u'inventory_substation', 'ip',
                      self.gf('django.db.models.fields.IPAddressField')(default=1, max_length=15),
                      keep_default=False)

        # Adding field 'SubStation.longitude'
        db.add_column(u'inventory_substation', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubStation.mac'
        db.add_column(u'inventory_substation', 'mac',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=250),
                      keep_default=False)

        # Adding field 'SubStation.latitude'
        db.add_column(u'inventory_substation', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SubStation.version'
        db.delete_column(u'inventory_substation', 'version')

        # Deleting field 'SubStation.cable_length'
        db.delete_column(u'inventory_substation', 'cable_length')

        # Deleting field 'Circuit.circuit_type'
        db.delete_column(u'inventory_circuit', 'circuit_type')
    ...
    models = {
        ...
        u'inventory.antenna': {
            ...
            'gain': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'inventory.sector': {
            ...
            'idu_type': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            ...
            'rf_bandwidth': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'rx_power': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'inventory.substation': {
            ...
            'alias': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'building_height': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cable_length': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
