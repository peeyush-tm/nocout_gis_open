...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseStation.maintenance_status'
        db.add_column(u'inventory_basestation', 'maintenance_status',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BaseStation.provisioning_status'
        db.add_column(u'inventory_basestation', 'provisioning_status',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseStation.maintenance_status'
        db.delete_column(u'inventory_basestation', 'maintenance_status')

        # Deleting field 'BaseStation.provisioning_status'
        db.delete_column(u'inventory_basestation', 'provisioning_status')
