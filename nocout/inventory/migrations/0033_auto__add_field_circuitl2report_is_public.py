...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CircuitL2Report.is_public'
        db.add_column(u'inventory_circuitl2report', 'is_public',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CircuitL2Report.is_public'
        db.delete_column(u'inventory_circuitl2report', 'is_public')
    ...
    models = {
        ...
        u'inventory.circuitl2report': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_public': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '250'}),
