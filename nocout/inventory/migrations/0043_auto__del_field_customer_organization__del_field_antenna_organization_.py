...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Customer.organization'
        db.delete_column(u'inventory_customer', 'organization_id')

        # Deleting field 'Antenna.organization'
        db.delete_column(u'inventory_antenna', 'organization_id')

        # Deleting field 'Backhaul.organization'
        db.delete_column(u'inventory_backhaul', 'organization_id')

        # Deleting field 'Sector.organization'
        db.delete_column(u'inventory_sector', 'organization_id')

        # Deleting field 'BaseStation.organization'
        db.delete_column(u'inventory_basestation', 'organization_id')

        # Deleting field 'SubStation.organization'
        db.delete_column(u'inventory_substation', 'organization_id')

        # Deleting field 'Circuit.organization'
        db.delete_column(u'inventory_circuit', 'organization_id')


    def backwards(self, orm):
        # Adding field 'Customer.organization'
        db.add_column(u'inventory_customer', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['organization.Organization']),
                      keep_default=False)

        # Adding field 'Antenna.organization'
        db.add_column(u'inventory_antenna', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['organization.Organization']),
                      keep_default=False)

        # Adding field 'Backhaul.organization'
        db.add_column(u'inventory_backhaul', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['organization.Organization']),
                      keep_default=False)

        # Adding field 'Sector.organization'
        db.add_column(u'inventory_sector', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['organization.Organization']),
                      keep_default=False)

        # Adding field 'BaseStation.organization'
        db.add_column(u'inventory_basestation', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['organization.Organization']),
                      keep_default=False)

        # Adding field 'SubStation.organization'
        db.add_column(u'inventory_substation', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['organization.Organization']),
                      keep_default=False)

        # Adding field 'Circuit.organization'
        db.add_column(u'inventory_circuit', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['organization.Organization']),
                      keep_default=False)
