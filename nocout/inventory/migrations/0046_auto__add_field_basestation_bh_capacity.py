...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseStation.bh_capacity'
        db.add_column(u'inventory_basestation', 'bh_capacity',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseStation.bh_capacity'
        db.delete_column(u'inventory_basestation', 'bh_capacity')
