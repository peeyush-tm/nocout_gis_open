...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inventory.created_at'
        db.add_column(u'inventory_inventory', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 18, 0, 0)),
                      keep_default=False)

        # Adding field 'Inventory.modified_at'
        db.add_column(u'inventory_inventory', 'modified_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 18, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Inventory.created_at'
        db.delete_column(u'inventory_inventory', 'created_at')

        # Deleting field 'Inventory.modified_at'
        db.delete_column(u'inventory_inventory', 'modified_at')
