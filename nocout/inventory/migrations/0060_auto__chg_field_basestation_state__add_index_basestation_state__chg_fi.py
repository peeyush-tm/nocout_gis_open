...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'BaseStation.state' to match new field type.
        db.rename_column(u'inventory_basestation', 'state', 'state_id')
        # Changing field 'BaseStation.state'
        db.alter_column(u'inventory_basestation', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.State'], null=True))
        # Adding index on 'BaseStation', fields ['state']
        db.create_index(u'inventory_basestation', ['state_id'])


        # Renaming column for 'BaseStation.city' to match new field type.
        db.rename_column(u'inventory_basestation', 'city', 'city_id')
        # Changing field 'BaseStation.city'
        db.alter_column(u'inventory_basestation', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.City'], null=True))
        # Adding index on 'BaseStation', fields ['city']
        db.create_index(u'inventory_basestation', ['city_id'])


        # Renaming column for 'BaseStation.country' to match new field type.
        db.rename_column(u'inventory_basestation', 'country', 'country_id')
        # Changing field 'BaseStation.country'
        db.alter_column(u'inventory_basestation', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.Country'], null=True))
        # Adding index on 'BaseStation', fields ['country']
        db.create_index(u'inventory_basestation', ['country_id'])


    def backwards(self, orm):
        # Removing index on 'BaseStation', fields ['country']
        db.delete_index(u'inventory_basestation', ['country_id'])

        # Removing index on 'BaseStation', fields ['city']
        db.delete_index(u'inventory_basestation', ['city_id'])

        # Removing index on 'BaseStation', fields ['state']
        db.delete_index(u'inventory_basestation', ['state_id'])


        # Renaming column for 'BaseStation.state' to match new field type.
        db.rename_column(u'inventory_basestation', 'state_id', 'state')
        # Changing field 'BaseStation.state'
        db.alter_column(u'inventory_basestation', 'state', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Renaming column for 'BaseStation.city' to match new field type.
        db.rename_column(u'inventory_basestation', 'city_id', 'city')
        # Changing field 'BaseStation.city'
        db.alter_column(u'inventory_basestation', 'city', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Renaming column for 'BaseStation.country' to match new field type.
        db.rename_column(u'inventory_basestation', 'country_id', 'country')
        # Changing field 'BaseStation.country'
        db.alter_column(u'inventory_basestation', 'country', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'inventory.circuit': {
            ...
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.Customer']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            ...
            'sector': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.Sector']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'sub_station': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.SubStation']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        u'inventory.gisexceldownload': {
            'Meta': {'object_name': 'GISExcelDownload'},
            'added_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'base_stations': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'inventory.substation': {
            ...
            'address': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'alias': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'antenna': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.Antenna']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'building_height': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'cable_length': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'city': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'country': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'device': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['device.Device']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
