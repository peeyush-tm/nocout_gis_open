...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PingThematicSettings', fields ['data_source']
        db.delete_unique(u'inventory_pingthematicsettings', ['data_source'])

        # Removing unique constraint on 'PingThematicSettings', fields ['service']
        db.delete_unique(u'inventory_pingthematicsettings', ['service'])


    def backwards(self, orm):
        # Adding unique constraint on 'PingThematicSettings', fields ['service']
        db.create_unique(u'inventory_pingthematicsettings', ['service'])

        # Adding unique constraint on 'PingThematicSettings', fields ['data_source']
        db.create_unique(u'inventory_pingthematicsettings', ['data_source'])
