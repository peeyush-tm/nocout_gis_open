...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Inventory.city'
        db.delete_column(u'inventory_inventory', 'city')

        # Deleting field 'Inventory.country'
        db.delete_column(u'inventory_inventory', 'country')

        # Deleting field 'Inventory.state'
        db.delete_column(u'inventory_inventory', 'state')


    def backwards(self, orm):
        # Adding field 'Inventory.city'
        db.add_column(u'inventory_inventory', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Inventory.country'
        db.add_column(u'inventory_inventory', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Inventory.state'
        db.add_column(u'inventory_inventory', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)
