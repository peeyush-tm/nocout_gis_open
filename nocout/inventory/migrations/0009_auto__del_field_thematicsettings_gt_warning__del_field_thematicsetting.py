...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'inventory_thematicsettings', 'gt_warning')

        # Deleting field 'ThematicSettings.bt_w_c'
        db.delete_column(u'inventory_thematicsettings', 'bt_w_c')

        # Deleting field 'ThematicSettings.gt_critical'
        db.delete_column(u'inventory_thematicsettings', 'gt_critical')
