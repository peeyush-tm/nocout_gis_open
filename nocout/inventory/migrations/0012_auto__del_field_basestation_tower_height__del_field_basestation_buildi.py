...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BaseStation.tower_height'
        db.delete_column(u'inventory_basestation', 'tower_height')

        # Deleting field 'BaseStation.building_height'
        db.delete_column(u'inventory_basestation', 'building_height')


    def backwards(self, orm):
        # Adding field 'BaseStation.tower_height'
        db.add_column(u'inventory_basestation', 'tower_height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BaseStation.building_height'
        db.add_column(u'inventory_basestation', 'building_height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
