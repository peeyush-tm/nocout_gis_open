...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Sector.frequency' to match new field type.
        db.rename_column(u'inventory_sector', 'frequency', 'frequency_id')
        # Changing field 'Sector.frequency'
        db.alter_column(u'inventory_sector', 'frequency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.DeviceFrequency'], null=True))
        # Adding index on 'Sector', fields ['frequency']
        db.create_index(u'inventory_sector', ['frequency_id'])


    def backwards(self, orm):
        # Removing index on 'Sector', fields ['frequency']
        db.delete_index(u'inventory_sector', ['frequency_id'])


        # Renaming column for 'Sector.frequency' to match new field type.
        db.rename_column(u'inventory_sector', 'frequency_id', 'frequency')
        # Changing field 'Sector.frequency'
        db.alter_column(u'inventory_sector', 'frequency', self.gf('django.db.models.fields.IntegerField')(null=True))
