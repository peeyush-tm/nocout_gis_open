...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CircuitL2Report', fields ['name']
        db.delete_unique(u'inventory_circuitl2report', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'CircuitL2Report', fields ['name']
        db.create_unique(u'inventory_circuitl2report', ['name'])
