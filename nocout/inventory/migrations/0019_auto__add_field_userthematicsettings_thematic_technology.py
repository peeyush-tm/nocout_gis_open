...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserThematicSettings.thematic_technology'
        db.add_column(u'inventory_userthematicsettings', 'thematic_technology',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.DeviceTechnology'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserThematicSettings.thematic_technology'
        db.delete_column(u'inventory_userthematicsettings', 'thematic_technology_id')
