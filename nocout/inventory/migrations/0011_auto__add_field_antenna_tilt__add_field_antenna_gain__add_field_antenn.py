...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Antenna.tilt'
        db.add_column(u'inventory_antenna', 'tilt',
        ...
        # Adding field 'Antenna.beam_width'
        db.add_column(u'inventory_antenna', 'beam_width',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Antenna.azimuth_angle'
        db.add_column(u'inventory_antenna', 'azimuth_angle',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Antenna.tilt'
        db.delete_column(u'inventory_antenna', 'tilt')

        # Deleting field 'Antenna.gain'
        db.delete_column(u'inventory_antenna', 'gain')

        # Deleting field 'Antenna.beam_width'
        db.delete_column(u'inventory_antenna', 'beam_width')

        # Deleting field 'Antenna.azimuth_angle'
        db.delete_column(u'inventory_antenna', 'azimuth_angle')
