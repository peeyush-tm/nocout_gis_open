...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseStation.backhaul'
        db.alter_column(u'inventory_basestation', 'backhaul_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Backhaul'], null=True))
        ...
        # Changing field 'Circuit.circuit_id'
        db.alter_column(u'inventory_circuit', 'circuit_id', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Sector.base_station'
        db.alter_column(u'inventory_sector', 'base_station_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inventory.BaseStation']))

        # Changing field 'BaseStation.backhaul'
        db.alter_column(u'inventory_basestation', 'backhaul_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inventory.Backhaul']))

        # Changing field 'Circuit.customer'
        db.alter_column(u'inventory_circuit', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inventory.Customer']))

        # Changing field 'Circuit.circuit_id'
        db.alter_column(u'inventory_circuit', 'circuit_id', self.gf('django.db.models.fields.CharField')(default=1, max_length=250))

        # Changing field 'Circuit.sub_station'
        db.alter_column(u'inventory_circuit', 'sub_station_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inventory.SubStation']))
    ...
    models = {
        ...
        u'inventory.basestation': {
            ...
            'address': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'alias': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'backhaul': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.Backhaul']", 'null': 'True', 'blank': 'True'}),
