...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sector.tx_power'
        db.add_column(u'inventory_sector', 'tx_power',
        ...
        # Adding field 'Sector.frequency'
        db.add_column(u'inventory_sector', 'frequency',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.frame_length'
        db.add_column(u'inventory_sector', 'frame_length',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.cell_radius'
        db.add_column(u'inventory_sector', 'cell_radius',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sector.tx_power'
        db.delete_column(u'inventory_sector', 'tx_power')

        # Deleting field 'Sector.rx_power'
        db.delete_column(u'inventory_sector', 'rx_power')

        # Deleting field 'Sector.frequency'
        db.delete_column(u'inventory_sector', 'frequency')

        # Deleting field 'Sector.frame_length'
        db.delete_column(u'inventory_sector', 'frame_length')

        # Deleting field 'Sector.cell_radius'
        db.delete_column(u'inventory_sector', 'cell_radius')
