...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inventory.user_group'
        db.add_column(u'inventory_inventory', 'user_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['user_group.UserGroup']),
                      keep_default=False)

        # Adding field 'Inventory.organization'
        db.add_column(u'inventory_inventory', 'organization',
    ...
    def backwards(self, orm):
        # Deleting field 'Inventory.user_group'
        db.delete_column(u'inventory_inventory', 'user_group_id')

        # Deleting field 'Inventory.organization'
        db.delete_column(u'inventory_inventory', 'organization_id')
    ...
    models = {
        ...
        u'device_group.devicedevicegroup': {
            'Meta': {'object_name': 'DeviceDeviceGroup'},
        ...
        u'device_group.devicegroup': {
            ...
            'devices': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['device.Device']", 'through': u"orm['device_group.DeviceDeviceGroup']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_deleted': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            u'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            u'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
        ...
        u'user_group.usergroup': {
            ...
            u'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            u'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['user_profile.UserProfile']", 'through': u"orm['user_group.UserUserGroup']", 'symmetrical': 'False'})
        },
        u'user_group.userusergroup': {
            'Meta': {'object_name': 'UserUserGroup'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'org_id': ('django.db.models.fields.IntegerField', [], {}),
            'user_group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['user_group.UserGroup']"}),
