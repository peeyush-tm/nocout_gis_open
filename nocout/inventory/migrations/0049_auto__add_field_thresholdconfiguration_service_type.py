...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThresholdConfiguration.service_type'
        db.add_column(u'inventory_thresholdconfiguration', 'service_type',
                      self.gf('django.db.models.fields.CharField')(default='INT', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ThresholdConfiguration.service_type'
        db.delete_column(u'inventory_thresholdconfiguration', 'service_type')
