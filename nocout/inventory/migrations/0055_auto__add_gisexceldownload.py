...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GISExcelDownload'
        db.create_table(u'inventory_gisexceldownload', (
        ...
        db.send_create_signal(u'inventory', ['GISExcelDownload'])


    def backwards(self, orm):
        # Deleting model 'GISExcelDownload'
        db.delete_table(u'inventory_gisexceldownload')
