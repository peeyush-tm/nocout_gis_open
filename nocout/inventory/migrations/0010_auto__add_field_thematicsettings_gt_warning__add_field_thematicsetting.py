...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThematicSettings.gt_warning'
        db.add_column(u'inventory_thematicsettings', 'gt_warning',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='gt_warning', null=True, to=orm['inventory.IconSettings']),
                      keep_default=False)

        # Adding field 'ThematicSettings.bt_w_c'
        db.add_column(u'inventory_thematicsettings', 'bt_w_c',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bt_w_c', null=True, to=orm['inventory.IconSettings']),
                      keep_default=False)

        # Adding field 'ThematicSettings.gt_critical'
        db.add_column(u'inventory_thematicsettings', 'gt_critical',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='gt_critical', null=True, to=orm['inventory.IconSettings']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ThematicSettings.gt_warning'
        db.delete_column(u'inventory_thematicsettings', 'gt_warning_id')

        # Deleting field 'ThematicSettings.bt_w_c'
        db.delete_column(u'inventory_thematicsettings', 'bt_w_c_id')

        # Deleting field 'ThematicSettings.gt_critical'
        db.delete_column(u'inventory_thematicsettings', 'gt_critical_id')
