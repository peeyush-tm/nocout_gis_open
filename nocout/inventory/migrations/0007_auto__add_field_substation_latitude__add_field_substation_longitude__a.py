...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubStation.mac_address'
        db.add_column(u'inventory_substation', 'mac_address',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SubStation.mac_address'
        db.delete_column(u'inventory_substation', 'mac_address')
