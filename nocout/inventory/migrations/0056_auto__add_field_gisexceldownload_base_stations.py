...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GISExcelDownload.base_stations'
        db.add_column(u'inventory_gisexceldownload', 'base_stations',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GISExcelDownload.base_stations'
        db.delete_column(u'inventory_gisexceldownload', 'base_stations')
