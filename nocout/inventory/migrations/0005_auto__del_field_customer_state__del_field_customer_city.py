...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'inventory_customer', 'state')

        # Deleting field 'Customer.city'
        db.delete_column(u'inventory_customer', 'city')


    def backwards(self, orm):
        # Adding field 'Customer.state'
        db.add_column(u'inventory_customer', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Customer.city'
        db.add_column(u'inventory_customer', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)
