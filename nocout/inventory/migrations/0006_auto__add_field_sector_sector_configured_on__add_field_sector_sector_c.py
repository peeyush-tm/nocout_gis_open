...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sector.sector_configured_on'
        db.add_column(u'inventory_sector', 'sector_configured_on',
                      self.gf('django.db.models.fields.related.ForeignKey')(max_length=250, related_name='sector_configured_on', null=True, to=orm['device.Device']),
                      keep_default=False)

        # Adding field 'Sector.sector_configured_on_port'
        db.add_column(u'inventory_sector', 'sector_configured_on_port',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.DevicePort'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sector.sector_configured_on'
        db.delete_column(u'inventory_sector', 'sector_configured_on_id')

        # Deleting field 'Sector.sector_configured_on_port'
        db.delete_column(u'inventory_sector', 'sector_configured_on_port_id')
