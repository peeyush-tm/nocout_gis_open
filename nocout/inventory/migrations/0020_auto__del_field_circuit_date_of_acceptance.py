...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Circuit.date_of_acceptance'
        db.delete_column(u'inventory_circuit', 'date_of_acceptance')


    def backwards(self, orm):
        # Adding field 'Circuit.date_of_acceptance'
        db.add_column(u'inventory_circuit', 'date_of_acceptance',
