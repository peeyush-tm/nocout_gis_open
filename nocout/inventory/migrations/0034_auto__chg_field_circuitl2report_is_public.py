...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CircuitL2Report.is_public'
        db.alter_column(u'inventory_circuitl2report', 'is_public', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'CircuitL2Report.is_public'
        db.alter_column(u'inventory_circuitl2report', 'is_public', self.gf('django.db.models.fields.IntegerField')())
