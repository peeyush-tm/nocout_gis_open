...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubStation.antenna'
        db.add_column(u'inventory_substation', 'antenna',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Antenna'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubStation.antenna'
        db.delete_column(u'inventory_substation', 'antenna_id')
