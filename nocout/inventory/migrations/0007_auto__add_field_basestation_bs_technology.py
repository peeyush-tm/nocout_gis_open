...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseStation.bs_technology'
        db.add_column(u'inventory_basestation', 'bs_technology',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.DeviceTechnology'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseStation.bs_technology'
        db.delete_column(u'inventory_basestation', 'bs_technology_id')
