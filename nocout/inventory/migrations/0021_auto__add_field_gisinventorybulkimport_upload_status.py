...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GISInventoryBulkImport.upload_status'
        db.add_column(u'inventory_gisinventorybulkimport', 'upload_status',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GISInventoryBulkImport.upload_status'
        db.delete_column(u'inventory_gisinventorybulkimport', 'upload_status')
