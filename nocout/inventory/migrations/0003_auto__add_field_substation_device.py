...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubStation.device'
        db.add_column(u'inventory_substation', 'device',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['device.Device']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubStation.device'
        db.delete_column(u'inventory_substation', 'device_id')
