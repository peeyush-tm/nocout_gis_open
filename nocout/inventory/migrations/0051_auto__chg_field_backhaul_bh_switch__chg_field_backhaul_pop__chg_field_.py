...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Backhaul.bh_switch'
        db.alter_column(u'inventory_backhaul', 'bh_switch_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['device.Device']))

        # Changing field 'Backhaul.pop'
        db.alter_column(u'inventory_backhaul', 'pop_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['device.Device']))

        # Changing field 'Backhaul.aggregator'
        db.alter_column(u'inventory_backhaul', 'aggregator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['device.Device']))

    def backwards(self, orm):

        # Changing field 'Backhaul.bh_switch'
        db.alter_column(u'inventory_backhaul', 'bh_switch_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['device.Device']))

        # Changing field 'Backhaul.pop'
        db.alter_column(u'inventory_backhaul', 'pop_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['device.Device']))

        # Changing field 'Backhaul.aggregator'
        db.alter_column(u'inventory_backhaul', 'aggregator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['device.Device']))
