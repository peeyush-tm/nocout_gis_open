...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inventory_basestation', 'backhaul_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Backhaul'], null=True, on_delete=models.SET_NULL))
