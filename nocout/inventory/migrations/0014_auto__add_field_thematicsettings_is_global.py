...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThematicSettings.is_global'
        db.add_column(u'inventory_thematicsettings', 'is_global',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ThematicSettings.is_global'
        db.delete_column(u'inventory_thematicsettings', 'is_global')
