...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inventory_circuitl2report', 'file_name', self.gf('django.db.models.fields.files.FileField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'CircuitL2Report.file_name'
        db.alter_column(u'inventory_circuitl2report', 'file_name', self.gf('django.db.models.fields.files.FileField')(max_length=255))
