...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PingThematicSettings'
        db.create_table(u'inventory_pingthematicsettings', (
            ...
            ('service', self.gf('django.db.models.fields.CharField')(unique=True, max_length=250)),
            ('data_source', self.gf('django.db.models.fields.CharField')(unique=True, max_length=250)),
        ...
        db.send_create_signal(u'inventory', ['PingThematicSettings'])

        # Adding model 'UserPingThematicSettings'
        db.create_table(u'inventory_userpingthematicsettings', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_profile.UserProfile'])),
            ('thematic_template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.PingThematicSettings'])),
            ('thematic_technology', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.DeviceTechnology'], null=True)),
        ))
        db.send_create_signal(u'inventory', ['UserPingThematicSettings'])


    def backwards(self, orm):
        # Deleting model 'PingThematicSettings'
        db.delete_table(u'inventory_pingthematicsettings')

        # Deleting model 'UserPingThematicSettings'
        db.delete_table(u'inventory_userpingthematicsettings')
    ...
    models = {
        ...
        u'inventory.pingthematicsettings': {
            ...
            'alias': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'data_source': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '250'}),
            ...
            'service': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '250'}),
            'technology': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['device.DeviceTechnology']"}),
