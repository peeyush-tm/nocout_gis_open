...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'inventory_thematicsettings', 'gt_warning',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='gt_warning', null=True, to=orm['inventory.IconSettings'], blank=True),
                      keep_default=False)

        # Adding field 'ThematicSettings.bt_w_c'
        db.add_column(u'inventory_thematicsettings', 'bt_w_c',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='bt_w_c', null=True, to=orm['inventory.IconSettings'], blank=True),
                      keep_default=False)

        # Adding field 'ThematicSettings.gt_critical'
        db.add_column(u'inventory_thematicsettings', 'gt_critical',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='gt_critical', null=True, to=orm['inventory.IconSettings'], blank=True),
                      keep_default=False)
