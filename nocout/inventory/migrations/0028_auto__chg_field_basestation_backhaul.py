...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'inventory_basestation', 'backhaul_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['inventory.Backhaul'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BaseStation.backhaul'
        raise RuntimeError("Cannot reverse this migration. 'BaseStation.backhaul' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'BaseStation.backhaul'
        db.alter_column(u'inventory_basestation', 'backhaul_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Backhaul']))
    ...
    models = {
        ...
        u'inventory.basestation': {
            ...
            'address': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'alias': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'backhaul': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'backhaul'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['inventory.Backhaul']", 'blank': 'True', 'null': 'True'}),
