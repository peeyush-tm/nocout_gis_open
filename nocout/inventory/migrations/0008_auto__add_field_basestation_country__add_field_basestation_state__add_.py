...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseStation.country'
        db.add_column(u'inventory_basestation', 'country',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BaseStation.state'
        db.add_column(u'inventory_basestation', 'state',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'BaseStation.city'
        db.add_column(u'inventory_basestation', 'city',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseStation.country'
        db.delete_column(u'inventory_basestation', 'country')

        # Deleting field 'BaseStation.state'
        db.delete_column(u'inventory_basestation', 'state')

        # Deleting field 'BaseStation.city'
        db.delete_column(u'inventory_basestation', 'city')
