...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Backhaul.bh_port_name'
        db.add_column(u'inventory_backhaul', 'bh_port_name',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Backhaul.switch_port_name'
        db.add_column(u'inventory_backhaul', 'switch_port_name',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Backhaul.pop_port_name'
        db.add_column(u'inventory_backhaul', 'pop_port_name',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Backhaul.aggregator_port_name'
        db.add_column(u'inventory_backhaul', 'aggregator_port_name',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.idu_port_name'
        db.add_column(u'inventory_sector', 'idu_port_name',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.odu_port_name'
        db.add_column(u'inventory_sector', 'odu_port_name',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Backhaul.bh_port_name'
        db.delete_column(u'inventory_backhaul', 'bh_port_name')

        # Deleting field 'Backhaul.switch_port_name'
        db.delete_column(u'inventory_backhaul', 'switch_port_name')

        # Deleting field 'Backhaul.pop_port_name'
        db.delete_column(u'inventory_backhaul', 'pop_port_name')

        # Deleting field 'Backhaul.aggregator_port_name'
        db.delete_column(u'inventory_backhaul', 'aggregator_port_name')

        # Deleting field 'Sector.idu_port_name'
        db.delete_column(u'inventory_sector', 'idu_port_name')

        # Deleting field 'Sector.odu_port_name'
        db.delete_column(u'inventory_sector', 'odu_port_name')
    ...
    models = {
        ...
        u'inventory.sector': {
            ...
            'idu_port_name': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
            ...
            'odu_port_name': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True', 'blank': 'True'}),
