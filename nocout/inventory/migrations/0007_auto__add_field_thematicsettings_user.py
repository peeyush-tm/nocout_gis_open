...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThematicSettings.user'
        db.add_column(u'inventory_thematicsettings', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ThematicSettings.user'
        db.delete_column(u'inventory_thematicsettings', 'user_id')
