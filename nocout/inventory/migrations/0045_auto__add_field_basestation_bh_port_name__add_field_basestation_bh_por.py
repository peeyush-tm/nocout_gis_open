...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseStation.bh_port_name'
        db.add_column(u'inventory_basestation', 'bh_port_name',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BaseStation.bh_port'
        db.add_column(u'inventory_basestation', 'bh_port',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseStation.bh_port_name'
        db.delete_column(u'inventory_basestation', 'bh_port_name')

        # Deleting field 'BaseStation.bh_port'
        db.delete_column(u'inventory_basestation', 'bh_port')
