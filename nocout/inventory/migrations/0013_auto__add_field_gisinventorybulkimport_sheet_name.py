...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GISInventoryBulkImport.sheet_name'
        db.add_column(u'inventory_gisinventorybulkimport', 'sheet_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GISInventoryBulkImport.sheet_name'
        db.delete_column(u'inventory_gisinventorybulkimport', 'sheet_name')
