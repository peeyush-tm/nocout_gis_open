...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GISExcelDownload.uploaded_by'
        db.delete_column(u'inventory_gisexceldownload', 'uploaded_by')


    def backwards(self, orm):
        # Adding field 'GISExcelDownload.uploaded_by'
        db.add_column(u'inventory_gisexceldownload', 'uploaded_by',
