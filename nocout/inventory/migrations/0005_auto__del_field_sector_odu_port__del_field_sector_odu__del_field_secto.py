...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sector.odu_port'
        db.delete_column(u'inventory_sector', 'odu_port')

        # Deleting field 'Sector.odu'
        db.delete_column(u'inventory_sector', 'odu_id')

        # Deleting field 'Sector.idu_port'
        db.delete_column(u'inventory_sector', 'idu_port')

        # Deleting field 'Sector.idu'
        db.delete_column(u'inventory_sector', 'idu_id')
    ...
    def backwards(self, orm):
        # Adding field 'Sector.odu_port'
        db.add_column(u'inventory_sector', 'odu_port',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.odu'
        db.add_column(u'inventory_sector', 'odu',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sector_odu', max_length=250, null=True, to=orm['device.Device'], blank=True),
                      keep_default=False)

        # Adding field 'Sector.idu_port'
        db.add_column(u'inventory_sector', 'idu_port',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Sector.idu'
        db.add_column(u'inventory_sector', 'idu',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sector_idu', max_length=250, null=True, to=orm['device.Device']),
                      keep_default=False)
