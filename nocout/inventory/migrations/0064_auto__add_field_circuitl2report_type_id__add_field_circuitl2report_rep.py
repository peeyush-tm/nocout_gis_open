...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CircuitL2Report.type_id'
        db.add_column(u'inventory_circuitl2report', 'type_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'CircuitL2Report.report_type'
        db.add_column(u'inventory_circuitl2report', 'report_type',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CircuitL2Report.type_id'
        db.delete_column(u'inventory_circuitl2report', 'type_id')

        # Deleting field 'CircuitL2Report.report_type'
        db.delete_column(u'inventory_circuitl2report', 'report_type')
    ...
    models = {
        ...
        u'inventory.circuitl2report': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '250'}),
            'report_type': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
