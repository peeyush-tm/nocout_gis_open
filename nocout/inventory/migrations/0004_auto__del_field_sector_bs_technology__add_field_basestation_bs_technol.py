...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sector.bs_technology'
        db.delete_column(u'inventory_sector', 'bs_technology_id')
    ...
    def backwards(self, orm):
        # Adding field 'Sector.bs_technology'
        db.add_column(u'inventory_sector', 'bs_technology',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.DeviceTechnology'], null=True, blank=True),
                      keep_default=False)
