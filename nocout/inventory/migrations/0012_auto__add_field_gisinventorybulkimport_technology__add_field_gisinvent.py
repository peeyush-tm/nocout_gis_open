...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GISInventoryBulkImport.technology'
        db.add_column(u'inventory_gisinventorybulkimport', 'technology',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GISInventoryBulkImport.description'
        db.add_column(u'inventory_gisinventorybulkimport', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GISInventoryBulkImport.technology'
        db.delete_column(u'inventory_gisinventorybulkimport', 'technology')

        # Deleting field 'GISInventoryBulkImport.description'
        db.delete_column(u'inventory_gisinventorybulkimport', 'description')
    ...
    models = {
        ...
        u'inventory.thematicsettings': {
            ...
            'user_profile': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['user_profile.UserProfile']", 'symmetrical': 'False'})
        },
