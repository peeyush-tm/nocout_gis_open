...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'SubStation.city' to match new field type.
        db.rename_column(u'inventory_substation', 'city', 'city_id')
        # Changing field 'SubStation.city'
        db.alter_column(u'inventory_substation', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.City'], null=True))
        # Adding index on 'SubStation', fields ['city']
        db.create_index(u'inventory_substation', ['city_id'])


        # Renaming column for 'SubStation.state' to match new field type.
        db.rename_column(u'inventory_substation', 'state', 'state_id')
        # Changing field 'SubStation.state'
        db.alter_column(u'inventory_substation', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.State'], null=True))
        # Adding index on 'SubStation', fields ['state']
        db.create_index(u'inventory_substation', ['state_id'])


        # Renaming column for 'SubStation.country' to match new field type.
        db.rename_column(u'inventory_substation', 'country', 'country_id')
        # Changing field 'SubStation.country'
        db.alter_column(u'inventory_substation', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.Country'], null=True))
        # Adding index on 'SubStation', fields ['country']
        db.create_index(u'inventory_substation', ['country_id'])


    def backwards(self, orm):
        # Removing index on 'SubStation', fields ['country']
        db.delete_index(u'inventory_substation', ['country_id'])

        # Removing index on 'SubStation', fields ['state']
        db.delete_index(u'inventory_substation', ['state_id'])

        # Removing index on 'SubStation', fields ['city']
        db.delete_index(u'inventory_substation', ['city_id'])


        # Renaming column for 'SubStation.city' to match new field type.
        db.rename_column(u'inventory_substation', 'city_id', 'city')
        # Changing field 'SubStation.city'
        db.alter_column(u'inventory_substation', 'city', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Renaming column for 'SubStation.state' to match new field type.
        db.rename_column(u'inventory_substation', 'state_id', 'state')
        # Changing field 'SubStation.state'
        db.alter_column(u'inventory_substation', 'state', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Renaming column for 'SubStation.country' to match new field type.
        db.rename_column(u'inventory_substation', 'country_id', 'country')
        # Changing field 'SubStation.country'
        db.alter_column(u'inventory_substation', 'country', self.gf('django.db.models.fields.IntegerField')(null=True))
