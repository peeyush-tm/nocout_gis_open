...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThematicSettings.icon_settings'
        db.add_column(u'inventory_thematicsettings', 'icon_settings',
                      self.gf('django.db.models.fields.TextField')(default='NULL'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ThematicSettings.icon_settings'
        db.delete_column(u'inventory_thematicsettings', 'icon_settings')
