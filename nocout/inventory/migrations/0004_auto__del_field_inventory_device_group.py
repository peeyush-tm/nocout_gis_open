...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Inventory.device_group'
        db.delete_column(u'inventory_inventory', 'device_group_id')
    ...
    def backwards(self, orm):
        # Adding field 'Inventory.device_group'
        db.add_column(u'inventory_inventory', 'device_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['device_group.DeviceGroup']),
                      keep_default=False)
