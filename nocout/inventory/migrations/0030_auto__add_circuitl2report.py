...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CircuitL2Report'
        db.create_table(u'inventory_circuitl2report', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=250)),
            ('file_name', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('added_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_profile.UserProfile'])),
            ('circuit_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Circuit'])),
        ))
        db.send_create_signal(u'inventory', ['CircuitL2Report'])


    def backwards(self, orm):
        # Deleting model 'CircuitL2Report'
        db.delete_table(u'inventory_circuitl2report')
    ...
    models = {
        ...
        u'inventory.circuitl2report': {
            ...
            'file_name': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '250'}),
