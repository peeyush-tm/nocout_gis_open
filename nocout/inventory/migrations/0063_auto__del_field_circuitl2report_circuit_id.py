...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CircuitL2Report.circuit_id'
        db.delete_column(u'inventory_circuitl2report', 'circuit_id_id')


    def backwards(self, orm):
        # Adding field 'CircuitL2Report.circuit_id'
        db.add_column(u'inventory_circuitl2report', 'circuit_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inventory.Circuit']),
                      keep_default=False)
