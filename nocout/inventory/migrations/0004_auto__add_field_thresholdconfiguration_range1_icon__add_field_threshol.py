...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThresholdConfiguration.range1_icon'
        db.add_column(u'inventory_thresholdconfiguration', 'range1_icon',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='range1_icon', null=True, to=orm['inventory.IconSettings']),
                      keep_default=False)

        # Adding field 'ThresholdConfiguration.range2_icon'
        db.add_column(u'inventory_thresholdconfiguration', 'range2_icon',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='range2_icon', null=True, to=orm['inventory.IconSettings']),
                      keep_default=False)

        # Adding field 'ThresholdConfiguration.range3_icon'
        db.add_column(u'inventory_thresholdconfiguration', 'range3_icon',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='range3_icon', null=True, to=orm['inventory.IconSettings']),
                      keep_default=False)

        # Adding field 'ThresholdConfiguration.range4_icon'
        db.add_column(u'inventory_thresholdconfiguration', 'range4_icon',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='range4_icon', null=True, to=orm['inventory.IconSettings']),
                      keep_default=False)

        # Adding field 'ThresholdConfiguration.range5_icon'
        db.add_column(u'inventory_thresholdconfiguration', 'range5_icon',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='range5_icon', null=True, to=orm['inventory.IconSettings']),
                      keep_default=False)

        # Adding field 'ThresholdConfiguration.range6_icon'
        db.add_column(u'inventory_thresholdconfiguration', 'range6_icon',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='range6_icon', null=True, to=orm['inventory.IconSettings']),
                      keep_default=False)

        # Adding field 'ThresholdConfiguration.range7_icon'
        db.add_column(u'inventory_thresholdconfiguration', 'range7_icon',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='range7_icon', null=True, to=orm['inventory.IconSettings']),
                      keep_default=False)

        # Adding field 'ThresholdConfiguration.range8_icon'
        db.add_column(u'inventory_thresholdconfiguration', 'range8_icon',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='range8_icon', null=True, to=orm['inventory.IconSettings']),
                      keep_default=False)

        # Adding field 'ThresholdConfiguration.range9_icon'
        db.add_column(u'inventory_thresholdconfiguration', 'range9_icon',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='range9_icon', null=True, to=orm['inventory.IconSettings']),
                      keep_default=False)

        # Adding field 'ThresholdConfiguration.range10_icon'
        db.add_column(u'inventory_thresholdconfiguration', 'range10_icon',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='range10_icon', null=True, to=orm['inventory.IconSettings']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ThresholdConfiguration.range1_icon'
        db.delete_column(u'inventory_thresholdconfiguration', 'range1_icon_id')

        # Deleting field 'ThresholdConfiguration.range2_icon'
        db.delete_column(u'inventory_thresholdconfiguration', 'range2_icon_id')

        # Deleting field 'ThresholdConfiguration.range3_icon'
        db.delete_column(u'inventory_thresholdconfiguration', 'range3_icon_id')

        # Deleting field 'ThresholdConfiguration.range4_icon'
        db.delete_column(u'inventory_thresholdconfiguration', 'range4_icon_id')

        # Deleting field 'ThresholdConfiguration.range5_icon'
        db.delete_column(u'inventory_thresholdconfiguration', 'range5_icon_id')

        # Deleting field 'ThresholdConfiguration.range6_icon'
        db.delete_column(u'inventory_thresholdconfiguration', 'range6_icon_id')

        # Deleting field 'ThresholdConfiguration.range7_icon'
        db.delete_column(u'inventory_thresholdconfiguration', 'range7_icon_id')

        # Deleting field 'ThresholdConfiguration.range8_icon'
        db.delete_column(u'inventory_thresholdconfiguration', 'range8_icon_id')

        # Deleting field 'ThresholdConfiguration.range9_icon'
        db.delete_column(u'inventory_thresholdconfiguration', 'range9_icon_id')

        # Deleting field 'ThresholdConfiguration.range10_icon'
        db.delete_column(u'inventory_thresholdconfiguration', 'range10_icon_id')
    ...
    models = {
        ...
        u'inventory.thresholdconfiguration': {
            ...
            'range10_icon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'range10_icon'", 'null': 'True', 'to': u"orm['inventory.IconSettings']"}),
            ...
            'range1_icon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'range1_icon'", 'null': 'True', 'to': u"orm['inventory.IconSettings']"}),
            ...
            'range2_icon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'range2_icon'", 'null': 'True', 'to': u"orm['inventory.IconSettings']"}),
            ...
            'range3_icon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'range3_icon'", 'null': 'True', 'to': u"orm['inventory.IconSettings']"}),
            ...
            'range4_icon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'range4_icon'", 'null': 'True', 'to': u"orm['inventory.IconSettings']"}),
            ...
            'range5_icon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'range5_icon'", 'null': 'True', 'to': u"orm['inventory.IconSettings']"}),
            ...
            'range6_icon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'range6_icon'", 'null': 'True', 'to': u"orm['inventory.IconSettings']"}),
            ...
            'range7_icon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'range7_icon'", 'null': 'True', 'to': u"orm['inventory.IconSettings']"}),
            ...
            'range8_icon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'range8_icon'", 'null': 'True', 'to': u"orm['inventory.IconSettings']"}),
            ...
            'range9_icon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'range9_icon'", 'null': 'True', 'to': u"orm['inventory.IconSettings']"}),
