...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseStation.hssu_port'
        db.add_column(u'inventory_basestation', 'hssu_port',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseStation.hssu_port'
        db.delete_column(u'inventory_basestation', 'hssu_port')
