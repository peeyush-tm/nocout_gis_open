"""
==========================================================
Module contains url configuration for 'site_instance' app.
==========================================================

Location:
* /nocout_gis/nocout/site_instance/urls.py
"""
...
urlpatterns = patterns('',
                       ...
                       url(r'^SiteInstanceListingTable/', views.SiteInstanceListingTable.as_view(),
                           name='SiteInstanceListingTable'),
)
