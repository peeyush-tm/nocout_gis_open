...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SiteInstance.site_ip'
        db.delete_column(u'site_instance_siteinstance', 'site_ip')


    def backwards(self, orm):
        # Adding field 'SiteInstance.site_ip'
        db.add_column(u'site_instance_siteinstance', 'site_ip',
                      self.gf('django.db.models.fields.IPAddressField')(default=None, max_length=15),
                      keep_default=False)
