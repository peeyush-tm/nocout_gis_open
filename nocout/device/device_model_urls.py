"""
====================================================================================
Module contains url configuration specific to 'device model' module in 'device' app.
====================================================================================

Location:
* /nocout_gis/nocout/device/device_model_urls.py
"""
...
urlpatterns = patterns('',
                       ...
                       url(r'^devicemodellistingtable/', views.DeviceModelListingTable.as_view(),
                           name='DeviceModelListingTable'),
                       )