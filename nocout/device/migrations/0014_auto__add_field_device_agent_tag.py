...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.agent_tag'
        db.add_column(u'device_device', 'agent_tag',
                      self.gf('django.db.models.fields.CharField')(default='check_mk', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.agent_tag'
        db.delete_column(u'device_device', 'agent_tag')
    ...
    models = {
        ...
        u'device.device': {
            ...
            'agent_tag': ('django.db.models.fields.CharField', [], {'default': "'check_mk'", 'max_length': '100'}),
