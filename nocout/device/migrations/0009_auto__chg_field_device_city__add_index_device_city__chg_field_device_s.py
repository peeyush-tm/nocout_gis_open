...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Device.city' to match new field type.
        db.rename_column(u'device_device', 'city', 'city_id')
        # Changing field 'Device.city'
        db.alter_column(u'device_device', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.City'], null=True))
        # Adding index on 'Device', fields ['city']
        db.create_index(u'device_device', ['city_id'])


        # Renaming column for 'Device.state' to match new field type.
        db.rename_column(u'device_device', 'state', 'state_id')
        # Changing field 'Device.state'
        db.alter_column(u'device_device', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.State'], null=True))
        # Adding index on 'Device', fields ['state']
        db.create_index(u'device_device', ['state_id'])


        # Renaming column for 'Device.country' to match new field type.
        db.rename_column(u'device_device', 'country', 'country_id')
        # Changing field 'Device.country'
        db.alter_column(u'device_device', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.Country'], null=True))
        # Adding index on 'Device', fields ['country']
        db.create_index(u'device_device', ['country_id'])


    def backwards(self, orm):
        # Removing index on 'Device', fields ['country']
        db.delete_index(u'device_device', ['country_id'])

        # Removing index on 'Device', fields ['state']
        db.delete_index(u'device_device', ['state_id'])

        # Removing index on 'Device', fields ['city']
        db.delete_index(u'device_device', ['city_id'])


        # Renaming column for 'Device.city' to match new field type.
        db.rename_column(u'device_device', 'city_id', 'city')
        # Changing field 'Device.city'
        db.alter_column(u'device_device', 'city', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Renaming column for 'Device.state' to match new field type.
        db.rename_column(u'device_device', 'state_id', 'state')
        # Changing field 'Device.state'
        db.alter_column(u'device_device', 'state', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Renaming column for 'Device.country' to match new field type.
        db.rename_column(u'device_device', 'country_id', 'country')
        # Changing field 'Device.country'
