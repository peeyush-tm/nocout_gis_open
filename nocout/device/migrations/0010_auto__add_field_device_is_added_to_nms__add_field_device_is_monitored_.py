...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.is_added_to_nms'
        db.add_column(u'device_device', 'is_added_to_nms',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)

        # Adding field 'Device.is_monitored_on_nms'
        db.add_column(u'device_device', 'is_monitored_on_nms',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.is_added_to_nms'
        db.delete_column(u'device_device', 'is_added_to_nms')

        # Deleting field 'Device.is_monitored_on_nms'
        db.delete_column(u'device_device', 'is_monitored_on_nms')
