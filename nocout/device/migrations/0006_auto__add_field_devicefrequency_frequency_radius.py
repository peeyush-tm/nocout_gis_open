...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceFrequency.frequency_radius'
        db.add_column(u'device_devicefrequency', 'frequency_radius',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceFrequency.frequency_radius'
        db.delete_column(u'device_devicefrequency', 'frequency_radius')
