...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.country'
        db.add_column(u'device_device', 'country',
    ...
    def backwards(self, orm):
        # Deleting field 'Device.country'
        db.delete_column(u'device_device', 'country')


        # Changing field 'Device.city'
        db.alter_column(u'device_device', 'city', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Device.state'
        db.alter_column(u'device_device', 'state', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'device.device': {
            ...
            'city': ('django.db.models.fields.IntegerField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'country': ('django.db.models.fields.IntegerField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'state': ('django.db.models.fields.IntegerField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
