...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DeviceFrequency.frequency_name'
        db.delete_column(u'device_devicefrequency', 'frequency_name')

        # Deleting field 'DeviceFrequency.frequency_value'
        db.delete_column(u'device_devicefrequency', 'frequency_value')

        # Adding field 'DeviceFrequency.value'
        db.add_column(u'device_devicefrequency', 'value',
                      self.gf('django.db.models.fields.CharField')(default='field is removed', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DeviceFrequency.frequency_name'
        db.add_column(u'device_devicefrequency', 'frequency_name',
                      self.gf('django.db.models.fields.CharField')(default='No Value', max_length=100),
                      keep_default=False)

        # Adding field 'DeviceFrequency.frequency_value'
        db.add_column(u'device_devicefrequency', 'frequency_value',
                      self.gf('django.db.models.fields.CharField')(default='2014-07-09', max_length=50),
                      keep_default=False)

        # Deleting field 'DeviceFrequency.value'
        db.delete_column(u'device_devicefrequency', 'value')
