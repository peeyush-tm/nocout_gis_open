...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceType.packets'
        db.add_column(u'device_devicetype', 'packets',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DeviceType.timeout'
        db.add_column(u'device_devicetype', 'timeout',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DeviceType.normal_check_interval'
        db.add_column(u'device_devicetype', 'normal_check_interval',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DeviceType.rta_warning'
        db.add_column(u'device_devicetype', 'rta_warning',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DeviceType.rta_critical'
        db.add_column(u'device_devicetype', 'rta_critical',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DeviceType.pl_warning'
        db.add_column(u'device_devicetype', 'pl_warning',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DeviceType.pl_critical'
        db.add_column(u'device_devicetype', 'pl_critical',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceType.packets'
        db.delete_column(u'device_devicetype', 'packets')

        # Deleting field 'DeviceType.timeout'
        db.delete_column(u'device_devicetype', 'timeout')

        # Deleting field 'DeviceType.normal_check_interval'
        db.delete_column(u'device_devicetype', 'normal_check_interval')

        # Deleting field 'DeviceType.rta_warning'
        db.delete_column(u'device_devicetype', 'rta_warning')

        # Deleting field 'DeviceType.rta_critical'
        db.delete_column(u'device_devicetype', 'rta_critical')

        # Deleting field 'DeviceType.pl_warning'
        db.delete_column(u'device_devicetype', 'pl_warning')

        # Deleting field 'DeviceType.pl_critical'
        db.delete_column(u'device_devicetype', 'pl_critical')
