...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceType.agent_tag'
        db.add_column(u'device_devicetype', 'agent_tag',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Device.description'
        db.alter_column(u'device_device', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'DeviceType.agent_tag'
        db.delete_column(u'device_devicetype', 'agent_tag')


        # Changing field 'Device.description'
        db.alter_column(u'device_device', 'description', self.gf('django.db.models.fields.TextField')(default='snmp'))
