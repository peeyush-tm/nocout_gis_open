...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StateGeoInfo.latitude'
        db.delete_column(u'device_stategeoinfo', 'latitude')

        # Deleting field 'StateGeoInfo.longitude'
        db.delete_column(u'device_stategeoinfo', 'longitude')

        # Deleting field 'StateGeoInfo.lat'
        db.delete_column(u'device_stategeoinfo', 'lat')

        # Deleting field 'StateGeoInfo.long'
        db.delete_column(u'device_stategeoinfo', 'long')


    def backwards(self, orm):
        # Adding field 'StateGeoInfo.latitude'
        db.add_column(u'device_stategeoinfo', 'latitude',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StateGeoInfo.longitude'
        db.add_column(u'device_stategeoinfo', 'longitude',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'StateGeoInfo.lat'
        db.add_column(u'device_stategeoinfo', 'lat',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=20, blank=True),
                      keep_default=False)

        # Adding field 'StateGeoInfo.long'
        db.add_column(u'device_stategeoinfo', 'long',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=20, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'device.device': {
            ...
            'latitude': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '25', 'decimal_places': '20', 'blank': 'True'}),
            u'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            u'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'longitude': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '25', 'decimal_places': '20', 'blank': 'True'}),
        ...
        u'device.stategeoinfo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lati': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
