...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeviceTypeServiceDataSource'
        db.create_table(u'device_devicetypeservicedatasource', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_type_service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.DeviceTypeService'])),
        ...
        db.send_create_signal(u'device', ['DeviceTypeServiceDataSource'])

        # Deleting field 'DeviceTypeService.warning'
        db.delete_column(u'device_devicetypeservice', 'warning')

        # Deleting field 'DeviceTypeService.critical'
        db.delete_column(u'device_devicetypeservice', 'critical')


    def backwards(self, orm):
        # Deleting model 'DeviceTypeServiceDataSource'
        db.delete_table(u'device_devicetypeservicedatasource')

        # Adding field 'DeviceTypeService.warning'
        db.add_column(u'device_devicetypeservice', 'warning',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DeviceTypeService.critical'
        db.add_column(u'device_devicetypeservice', 'critical',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
