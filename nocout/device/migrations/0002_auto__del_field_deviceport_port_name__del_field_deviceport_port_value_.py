...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DevicePort.port_name'
        db.delete_column(u'device_deviceport', 'port_name')

        # Deleting field 'DevicePort.port_value'
        db.delete_column(u'device_deviceport', 'port_value')

        # Adding field 'DevicePort.name'
        db.add_column(u'device_deviceport', 'name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'DevicePort.value'
        db.add_column(u'device_deviceport', 'value',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DevicePort.port_name'
        db.add_column(u'device_deviceport', 'port_name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'DevicePort.port_value'
        db.add_column(u'device_deviceport', 'port_value',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'DevicePort.name'
        db.delete_column(u'device_deviceport', 'name')

        # Deleting field 'DevicePort.value'
        db.delete_column(u'device_deviceport', 'value')
