...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Device.state'
        db.add_column(u'device_device', 'state',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Device.city'
        db.add_column(u'device_device', 'city',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Device.state'
        db.delete_column(u'device_device', 'state')

        # Deleting field 'Device.city'
        db.delete_column(u'device_device', 'city')
