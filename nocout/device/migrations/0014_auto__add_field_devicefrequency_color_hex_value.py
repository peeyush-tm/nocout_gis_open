...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeviceFrequency.color_hex_value'
        db.add_column(u'device_devicefrequency', 'color_hex_value',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeviceFrequency.color_hex_value'
        db.delete_column(u'device_devicefrequency', 'color_hex_value')
