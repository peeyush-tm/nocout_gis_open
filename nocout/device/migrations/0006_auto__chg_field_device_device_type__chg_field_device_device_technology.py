...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'device_device', 'device_type', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Device.device_technology'
        db.alter_column(u'device_device', 'device_technology', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Device.city'
        db.alter_column(u'device_device', 'city', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Device.state'
        db.alter_column(u'device_device', 'state', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Device.device_vendor'
        db.alter_column(u'device_device', 'device_vendor', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Device.device_model'
        db.alter_column(u'device_device', 'device_model', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Device.country'
        db.alter_column(u'device_device', 'country', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Device.device_type'
        db.alter_column(u'device_device', 'device_type', self.gf('django.db.models.fields.IntegerField')(max_length=200, null=True))

        # Changing field 'Device.device_technology'
        db.alter_column(u'device_device', 'device_technology', self.gf('django.db.models.fields.IntegerField')(max_length=200, null=True))

        # Changing field 'Device.city'
        db.alter_column(u'device_device', 'city', self.gf('django.db.models.fields.IntegerField')(max_length=200, null=True))

        # Changing field 'Device.state'
        db.alter_column(u'device_device', 'state', self.gf('django.db.models.fields.IntegerField')(max_length=200, null=True))

        # Changing field 'Device.device_vendor'
        db.alter_column(u'device_device', 'device_vendor', self.gf('django.db.models.fields.IntegerField')(max_length=200, null=True))

        # Changing field 'Device.device_model'
        db.alter_column(u'device_device', 'device_model', self.gf('django.db.models.fields.IntegerField')(max_length=200, null=True))

        # Changing field 'Device.country'
        db.alter_column(u'device_device', 'country', self.gf('django.db.models.fields.IntegerField')(max_length=200, null=True))
