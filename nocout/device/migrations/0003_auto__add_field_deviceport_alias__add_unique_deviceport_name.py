...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DevicePort.alias'
        db.add_column(u'device_deviceport', 'alias',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'DevicePort', fields ['name']
        db.create_unique(u'device_deviceport', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'DevicePort', fields ['name']
        db.delete_unique(u'device_deviceport', ['name'])

        # Deleting field 'DevicePort.alias'
        db.delete_column(u'device_deviceport', 'alias')
