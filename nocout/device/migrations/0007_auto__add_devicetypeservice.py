...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeviceTypeService'
        db.create_table(u'device_devicetypeservice', (
            ...
            ('parameter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.ServiceParameters'])),
        ...
        db.send_create_signal(u'device', ['DeviceTypeService'])
    ...
    def backwards(self, orm):
        # Deleting model 'DeviceTypeService'
        db.delete_table(u'device_devicetypeservice')
