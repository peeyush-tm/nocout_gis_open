...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'device_device', 'device_type', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'Device.device_technology'
        db.alter_column(u'device_device', 'device_technology', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'Device.device_vendor'
        db.alter_column(u'device_device', 'device_vendor', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'Device.device_model'
        db.alter_column(u'device_device', 'device_model', self.gf('django.db.models.fields.IntegerField')(default=1))
