...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Device.lat'
        db.delete_column(u'device_device', 'lat')

        # Deleting field 'Device.lng'
        db.delete_column(u'device_device', 'lng')

        # Adding field 'Device.latitude'
        db.add_column(u'device_device', 'latitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=20, blank=True),
                      keep_default=False)

        # Adding field 'Device.longitude'
        db.add_column(u'device_device', 'longitude',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Device.lat'
        db.add_column(u'device_device', 'lat',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=20, blank=True),
                      keep_default=False)

        # Adding field 'Device.lng'
        db.add_column(u'device_device', 'lng',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=20, blank=True),
                      keep_default=False)

        # Deleting field 'Device.latitude'
        db.delete_column(u'device_device', 'latitude')

        # Deleting field 'Device.longitude'
        db.delete_column(u'device_device', 'longitude')
