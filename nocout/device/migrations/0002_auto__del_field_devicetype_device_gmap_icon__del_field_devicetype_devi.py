...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DeviceType.device_gmap_icon'
        db.delete_column(u'device_devicetype', 'device_gmap_icon')

        # Deleting field 'DeviceType.device_icon'
        db.delete_column(u'device_devicetype', 'device_icon')

        # Adding field 'DeviceType.upload_image'
        db.add_column(u'device_devicetype', 'upload_image',
                      self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DeviceType.device_gmap_icon'
        db.add_column(u'device_devicetype', 'device_gmap_icon',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DeviceType.device_icon'
        db.add_column(u'device_devicetype', 'device_icon',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DeviceType.upload_image'
        db.delete_column(u'device_devicetype', 'upload_image')
