...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeviceSyncHistory'
        db.create_table(u'device_devicesynchistory', (
        ...
        db.send_create_signal(u'device', ['DeviceSyncHistory'])


    def backwards(self, orm):
        # Deleting model 'DeviceSyncHistory'
        db.delete_table(u'device_devicesynchistory')
