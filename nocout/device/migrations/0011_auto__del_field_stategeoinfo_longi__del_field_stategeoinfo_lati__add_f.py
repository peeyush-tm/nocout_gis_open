...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StateGeoInfo.longi'
        db.delete_column(u'device_stategeoinfo', 'longi')

        # Deleting field 'StateGeoInfo.lati'
        db.delete_column(u'device_stategeoinfo', 'lati')
    ...
    def backwards(self, orm):
        # Adding field 'StateGeoInfo.longi'
        db.add_column(u'device_stategeoinfo', 'longi',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'StateGeoInfo.lati'
        db.add_column(u'device_stategeoinfo', 'lati',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
