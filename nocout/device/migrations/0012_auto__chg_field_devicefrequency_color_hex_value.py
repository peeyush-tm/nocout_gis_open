...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeviceFrequency.color_hex_value'
        db.alter_column(u'device_devicefrequency', 'color_hex_value', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'DeviceFrequency.color_hex_value'
        db.alter_column(u'device_devicefrequency', 'color_hex_value', self.gf('django.db.models.fields.CharField')(max_length=10))
