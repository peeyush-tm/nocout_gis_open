...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.organization'
        db.add_column(u'device_device', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['organization.Organization']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.organization'
        db.delete_column(u'device_device', 'organization_id')
