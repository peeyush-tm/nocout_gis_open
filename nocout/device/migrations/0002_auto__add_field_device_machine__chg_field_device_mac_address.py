...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Device.machine'
        db.add_column(u'device_device', 'machine',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['machine.Machine'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Device.mac_address'
        db.alter_column(u'device_device', 'mac_address', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Device.machine'
        db.delete_column(u'device_device', 'machine_id')


        # Changing field 'Device.mac_address'
        db.alter_column(u'device_device', 'mac_address', self.gf('django.db.models.fields.CharField')(default=None, max_length=100))
