...
class DeviceTypeUpdate(PermissionsRequiredMixin, UpdateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        # device_type_service_create_form = DeviceTypeServiceCreateFormset(self.request.POST, prefix='dts')
        # print(device_type_service_create_form)
        if (device_type_service_form.is_valid()):
            # try:
            ...
            for i in range(int(total_forms)):
                ...
                # dt_service = DeviceTypeService.objects.get(id=dt_service_id)
                # print(dt_service)
                # formset = DeviceTypeServiceDataSourceUpdateFormset(self.request.POST, instance=dt_service, prefix='sds-{}'.format(sds))
                # print(formset.forms)
                # dt_service_data_formset.update({dt_service_id: formset})
