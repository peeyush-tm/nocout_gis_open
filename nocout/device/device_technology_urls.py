...
urlpatterns = patterns('',
  ...
  url(r'^(?P<pk>\d+)/edit/$', views.DeviceTechnologyUpdate.as_view(), name='device_technology_edit'),
  url(r'^(?P<pk>\d+)/delete/$', views.DeviceTechnologyDelete.as_view(), name='device_technology_delete'),
