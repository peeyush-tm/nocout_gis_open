"""
===================================================================================
Module contains url configuration specific to 'device type' module in 'device' app.
===================================================================================

Location:
* /nocout_gis/nocout/device/device_type_urls.py
"""
...
urlpatterns = patterns('',
                       ...
                       url(r'^devicetypelistingtable/$', views.DeviceTypeListingTable.as_view(),
                           name='DeviceTypeListingTable'),
                       )