"""
=====================================================================================
Module contains url configuration specific to 'device vendor' module in 'device' app.
=====================================================================================

Location:
* /nocout_gis/nocout/device/device_vendor_urls.py
"""
...
urlpatterns = patterns('',
                       ...
                       url(r'^DeviceVendorListingTable/', views.DeviceVendorListingTable.as_view(),
                           name='DeviceVendorListingTable'),
                       )