...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EscalationStatus.technology'
        db.delete_column(u'alarm_escalation_escalationstatus', 'technology_id')

        # Deleting field 'EscalationStatus.alert_description'
        db.delete_column(u'alarm_escalation_escalationstatus', 'alert_description')


        # Renaming column for 'EscalationStatus.device_type' to match new field type.
        db.rename_column(u'alarm_escalation_escalationstatus', 'device_type_id', 'device_type')
        ...
        # Renaming column for 'EscalationStatus.service' to match new field type.
        db.rename_column(u'alarm_escalation_escalationstatus', 'service_id', 'service')
        ...
        # Renaming column for 'EscalationStatus.service_data_source' to match new field type.
        db.rename_column(u'alarm_escalation_escalationstatus', 'service_data_source_id', 'service_data_source')
    ...
    def backwards(self, orm):
        # Adding field 'EscalationStatus.technology'
        db.add_column(u'alarm_escalation_escalationstatus', 'technology',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['device.DeviceTechnology']),
                      keep_default=False)

        # Adding field 'EscalationStatus.alert_description'
        db.add_column(u'alarm_escalation_escalationstatus', 'alert_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Renaming column for 'EscalationStatus.device_type' to match new field type.
        db.rename_column(u'alarm_escalation_escalationstatus', 'device_type', 'device_type_id')
        # Changing field 'EscalationStatus.device_type'
        db.alter_column(u'alarm_escalation_escalationstatus', 'device_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['device.DeviceType']))

        # Renaming column for 'EscalationStatus.service' to match new field type.
        db.rename_column(u'alarm_escalation_escalationstatus', 'service', 'service_id')
        # Changing field 'EscalationStatus.service'
        db.alter_column(u'alarm_escalation_escalationstatus', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.Service']))

        # Renaming column for 'EscalationStatus.service_data_source' to match new field type.
        db.rename_column(u'alarm_escalation_escalationstatus', 'service_data_source', 'service_data_source_id')
        # Changing field 'EscalationStatus.service_data_source'
        db.alter_column(u'alarm_escalation_escalationstatus', 'service_data_source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.ServiceDataSource']))
