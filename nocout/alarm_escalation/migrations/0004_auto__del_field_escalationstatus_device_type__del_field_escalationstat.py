...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EscalationStatus.device'
        db.add_column(u'alarm_escalation_escalationstatus', 'device',
        ...
        db.add_column(u'alarm_escalation_escalationstatus', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['service.Service']),
                      keep_default=False
        )
        ...
        db.add_column(u'alarm_escalation_escalationstatus', 'service_data_source',
                      ...
                      (default=1, to=orm['service.ServiceDataSource']),
                      keep_default=False
        )
