...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Downloader.headers_data'
        db.add_column(u'downloader_downloader', 'headers_data',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Downloader.rows_data'
        db.add_column(u'downloader_downloader', 'rows_data',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Downloader.headers_data'
        db.delete_column(u'downloader_downloader', 'headers_data')

        # Deleting field 'Downloader.rows_data'
        db.delete_column(u'downloader_downloader', 'rows_data')
