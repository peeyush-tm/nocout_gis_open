...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SectorCapacityStatus.sector_capacity_in'
        db.add_column(u'capacity_management_sectorcapacitystatus', 'sector_capacity_in',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'SectorCapacityStatus.sector_capacity_out'
        db.add_column(u'capacity_management_sectorcapacitystatus', 'sector_capacity_out',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SectorCapacityStatus.sector_capacity_in'
        db.delete_column(u'capacity_management_sectorcapacitystatus', 'sector_capacity_in')

        # Deleting field 'SectorCapacityStatus.sector_capacity_out'
        db.delete_column(u'capacity_management_sectorcapacitystatus', 'sector_capacity_out')


    models = {
        u'capacity_management.backhaulcapacitystatus': {
            'Meta': {'ordering': "['-sys_timestamp']", 'object_name': 'BackhaulCapacityStatus'},
            ...
            'backhaul_capacity': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'basestation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.BaseStation']"}),
            'bh_port_name': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '64', 'null': 'True', 'blank': 'True'}),
        ...
        u'capacity_management.sectorcapacitystatus': {
            ...
            'sector_capacity_in': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'sector_capacity_out': ('django.db.models.fields.FloatField', [], {'default': '0'}),
