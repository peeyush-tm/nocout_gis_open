...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'SectorCapacityStatus', fields ['sector_sector_id']
        db.delete_index(u'capacity_management_sectorcapacitystatus', ['sector_sector_id'])

        # Adding unique constraint on 'SectorCapacityStatus', fields ['sector_sector_id']
        db.create_unique(u'capacity_management_sectorcapacitystatus', ['sector_sector_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SectorCapacityStatus', fields ['sector_sector_id']
        db.delete_unique(u'capacity_management_sectorcapacitystatus', ['sector_sector_id'])

        # Adding index on 'SectorCapacityStatus', fields ['sector_sector_id']
        db.create_index(u'capacity_management_sectorcapacitystatus', ['sector_sector_id'])
