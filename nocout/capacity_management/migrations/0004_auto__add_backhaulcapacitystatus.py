...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BackhaulCapacityStatus'
        db.create_table(u'capacity_management_backhaulcapacitystatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('backhaul', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Backhaul'])),
            ('basestation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.BaseStation'])),
            ('bh_port_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=64, null=True, blank=True)),
            ('backhaul_capacity', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('current_in_per', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('current_in_val', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('avg_in_per', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('avg_in_val', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('peak_in_per', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('peak_in_val', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('peak_in_timestamp', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('current_out_per', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('current_out_val', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('avg_out_per', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('avg_out_val', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('peak_out_per', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('peak_out_val', self.gf('django.db.models.fields.FloatField')(default=0)),
        ...
        db.send_create_signal(u'capacity_management', ['BackhaulCapacityStatus'])


    def backwards(self, orm):
        # Deleting model 'BackhaulCapacityStatus'
        db.delete_table(u'capacity_management_backhaulcapacitystatus')
