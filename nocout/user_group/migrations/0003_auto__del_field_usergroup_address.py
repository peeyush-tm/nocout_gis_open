...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserGroup.address'
        db.delete_column(u'user_group_usergroup', 'address')


    def backwards(self, orm):
        # Adding field 'UserGroup.address'
        db.add_column(u'user_group_usergroup', 'address',
