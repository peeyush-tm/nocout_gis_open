...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserGroup.location'
        db.delete_column(u'user_group_usergroup', 'location')


    def backwards(self, orm):
        # Adding field 'UserGroup.location'
        db.add_column(u'user_group_usergroup', 'location',
