...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserGroup.organization'
        db.delete_column(u'user_group_usergroup', 'organization_id')


    def backwards(self, orm):
        # Adding field 'UserGroup.organization'
        db.add_column(u'user_group_usergroup', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['user_group.Organization']),
                      keep_default=False)
    ...
    models = {
        ...
        u'user_group.organization': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'device_group': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['device_group.DeviceGroup']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'user_group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'organization_user_group'", 'to': u"orm['user_group.UserGroup']"})
        },
