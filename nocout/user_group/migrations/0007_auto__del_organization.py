...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'user_group_organization_device_group'))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'user_group_organization', (
            ...
            ('user_group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='organization_user_group', to=orm['user_group.UserGroup'])),
        ...
        m2m_table_name = db.shorten_name(u'user_group_organization_device_group')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('organization', models.ForeignKey(orm[u'user_group.organization'], null=False)),
